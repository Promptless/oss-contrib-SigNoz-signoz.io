...
More details about the metrics can be found <a href="https://opentelemetry.io/docs/specs/semconv/gen-ai/gen-ai-metrics/" target="_blank" rel="noopener noreferrer nofollow">here</a>.
