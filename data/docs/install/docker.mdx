...
- On macOS, you must manually install <a href="https://docs.docker.com/engine/install/" target="_blank" rel="noopener noreferrer nofollow">Docker Engine</a>
...
<Admonition type="info">
Before you install SigNoz, ensure that <a href="https://docs.docker.com/compose/install/" target="_blank" rel="noopener noreferrer nofollow">Docker Compose</a> is installed on your machine.
</Admonition>
