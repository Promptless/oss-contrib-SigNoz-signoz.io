...
1. Install Clickhouse using the Clickhouse installation <a href="https://clickhouse.com/docs/install#available-installation-options" target="_blank" rel="noopener noreferrer nofollow">guide</a>
...
2. Get and extract the latest release of Zookeeper from the <a href="https://zookeeper.apache.org/releases.html" target="_blank" rel="noopener noreferrer nofollow">releases page</a>
