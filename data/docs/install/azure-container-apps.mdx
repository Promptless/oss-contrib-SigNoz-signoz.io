...
2. **Permissions** to:
   - Create <a href="https://learn.microsoft.com/azure/container-apps/environment" target="_blank" rel="noopener noreferrer nofollow">Container Apps environments</a>
   - Create <a href="https://learn.microsoft.com/azure/container-apps/storage-mounts?pivots=azure-files" target="_blank" rel="noopener noreferrer nofollow">storage accounts and file shares</a>
...
Install the <a href="https://learn.microsoft.com/en-us/cli/azure/install-azure-cli" target="_blank" rel="noopener noreferrer nofollow">Azure CLI</a> and add the Container Apps extension:

```bash
az extension add --name containerapp
```

For detailed setup instructions, refer to the <a href="https://learn.microsoft.com/azure/container-apps/get-started?tabs=bash#setup" target="_blank" rel="noopener noreferrer nofollow">getting started guide</a>.
...
> **Note**: The storage account name must be globally unique, contain only lowercase letters and numbers, and be between 3-24 characters. See <a href="https://learn.microsoft.com/azure/container-apps/quotas#region-availability" target="_blank" rel="noopener noreferrer nofollow">supported regions</a> for available locations.
...
ClickHouse requires persistent storage for configuration files. Learn more about <a href="https://learn.microsoft.com/azure/container-apps/storage-mounts?pivots=azure-files" target="_blank" rel="noopener noreferrer nofollow">Azure Files with Container Apps</a>:
