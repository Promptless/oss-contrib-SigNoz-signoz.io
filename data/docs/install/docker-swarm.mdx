...
- <a href="https://docs.docker.com/get-docker/" target="_blank" rel="noopener noreferrer nofollow">Docker Engine</a>. A minimum of 4GB of memory
must be allocated to each Docker node.
- <a href="https://docs.docker.com/compose/install/" target="_blank" rel="noopener noreferrer nofollow">Docker Compose</a>
...
3. _(Optional)_ You can use the `docker swarm join` command to add more nodes to the swarm.
    ...
    <a href="https://docs.docker.com/engine/reference/commandline/swarm_join/" target="_blank" rel="noopener noreferrer nofollow">Docker Swarm Join</a>
...
SigNoz uses the <a href="https://github.com/open-telemetry/opentelemetry-collector" target="_blank" rel="noopener noreferrer nofollow">OpenTelemetry Collector</a> to ingest data.
