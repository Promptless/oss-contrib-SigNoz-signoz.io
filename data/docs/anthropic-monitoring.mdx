...
- An <a href="https://docs.anthropic.com/en/home" target="_blank" rel="noopener noreferrer nofollow">Anthropic</a> API account with a working API Key
