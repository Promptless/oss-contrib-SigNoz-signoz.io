...
In order to log routes from GCP services to SigNoz, we use the <a href="https://cloud.google.com/logging/docs/routing/overview" target="_blank" rel="noopener noreferrer nofollow">Log Router</a>. This document details the steps to be taken for setting up the log router.
