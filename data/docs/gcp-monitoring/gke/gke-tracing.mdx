...
* A <a href="https://cloud.google.com/kubernetes-engine" target="_blank" rel="noopener noreferrer nofollow">GKE cluster</a>
* <a href="https://kubernetes.io/docs/tasks/tools/install-kubectl-linux/" target="_blank" rel="noopener noreferrer nofollow">kubectl</a> installed to access the GKE cluster
* <a href="https://helm.sh/docs/intro/install/" target="_blank" rel="noopener noreferrer nofollow">Helm</a> installed
...
- <a href="https://github.com/pixie-io/pixie" target="_blank" rel="noopener noreferrer nofollow">Pixie</a> 
- <a href="https://github.com/cilium/hubble" target="_blank" rel="noopener noreferrer nofollow">Hubble</a> 
- <a href="https://github.com/open-telemetry/opentelemetry-network" target="_blank" rel="noopener noreferrer nofollow">OpenTelemetry eBPF</a>
...
For eBPF tracing we can use Pixie, which can be configured using the following instructions in this <a href="https://docs.px.dev/tutorials/integrations/otel/" target="_blank" rel="noopener noreferrer nofollow">Documentation</a>.

**Step 2:** Use a custom Data retention script in the OpenTelemetry Pixie plugin to send the data to the SigNoz.

You can refer to this <a href="https://github.com/isItObservable/pixie/tree/master/pixie%20plugin" target="_blank" rel="noopener noreferrer nofollow">GitHub repository</a> for the different custom scripts for the different use cases.
...
We will use a <a href="https://github.com/SigNoz/sample-flask-app" target="_blank" rel="noopener noreferrer nofollow">sample flask app</a>.
