...
* <a href="https://console.cloud.google.com/" target="_blank" rel="noopener noreferrer nofollow">Google Cloud account</a> with administrative privilege or Cloud Run Admin, Artifact Registry Admin, Compute Engine Admin, Pub/Sub Admin and Logging Admin privileges.
