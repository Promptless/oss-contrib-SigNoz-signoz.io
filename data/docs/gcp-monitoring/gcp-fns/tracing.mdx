...
OpenTelemetry JS recommends using matching `latest` package lines together. Compatibility matrix: https://github.com/open-telemetry/opentelemetry-js#package-version-compatibility
</details>
