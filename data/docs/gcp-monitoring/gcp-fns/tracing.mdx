...
* <a href="https://console.cloud.google.com/" target="_blank" rel="noopener noreferrer nofollow">Google Cloud account</a> with administrative privilege or Cloud Functions Admin privilege.
* Access to a project in GCP
* Google Cloud Functions APIs enabled (follow <a href="https://support.google.com/googleapi/answer/6158841?hl=en" target="_blank" rel="noopener noreferrer nofollow">this</a> guide to see how to enable an API in Google Cloud)
