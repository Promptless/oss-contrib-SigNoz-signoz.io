...
1. <a href="https://console.cloud.google.com/" target="_blank" rel="noopener noreferrer nofollow">Google Cloud account</a> with administrative privilege or load balancer Admin privilege.
2. Cloud Load Balancer (logging should be enabled)
3. Access to a project in GCP
4. <a href="https://console.cloud.google.com/apis/api/monitoring.googleapis.com" target="_blank" rel="noopener noreferrer nofollow">Google Cloud Monitoring API</a> enabled
...
1. <a href="https://console.cloud.google.com/" target="_blank" rel="noopener noreferrer nofollow">Google Cloud account</a> with administrative privilege or load balancer Admin privilege.
2. Cloud Load Balancer (logging should be enabled)
3. <a href="https://console.cloud.google.com/apis/api/monitoring.googleapis.com" target="_blank" rel="noopener noreferrer nofollow">Google Cloud Monitoring API</a> enabled
