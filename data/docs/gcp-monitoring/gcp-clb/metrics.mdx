...
* You should have a <a href="https://console.cloud.google.com/" target="_blank" rel="noopener noreferrer nofollow">Google Cloud account</a> with administrative privileges or Cloud Load Balancer Admin privileges both should suffice.
* Cloud Load Balancer
* Access to a project in Google Cloud Platform (GCP).
* The Google Cloud Load Balancer APIs must be enabled. You can follow <a href="https://support.google.com/googleapi/answer/6158841?hl=en" target="_blank" rel="noopener noreferrer nofollow">this</a> guide to learn how to enable an API in Google Cloud.
...
Under the `googlecloudmonitoring` receiver, you need to specify the metrics that you want to capture in the `metrics_list`. You can include all the metrics that you would like to capture for Cloud Load Balancer, see the <a href="https://cloud.google.com/monitoring/api/metrics_gcp#gcp-loadbalancing" target="_blank" rel="noopener noreferrer nofollow">available metrics for Cloud Load Balancer</a>.
...
* A <a href="https://console.cloud.google.com/" target="_blank" rel="noopener noreferrer nofollow">Google Cloud account</a> with administrative privileges or Cloud Load Balancer Admin privileges.
* Cloud Load Balancer
* Access to a project in Google Cloud Platform (GCP).
* The Google Cloud Load Balancer APIs must be enabled. You can follow <a href="https://support.google.com/googleapi/answer/6158841?hl=en" target="_blank" rel="noopener noreferrer nofollow">this</a> guide to learn how to enable an API in Google Cloud.
