...
* <a href="https://console.cloud.google.com/" target="_blank" rel="noopener noreferrer nofollow">Google Cloud account</a> with administrative privilege or Compute Instance Admin privilege.
...
Step 1: Please refer to <a href="https://docs.npmjs.com/downloading-and-installing-node-js-and-npm" target="_blank" rel="noopener noreferrer nofollow">this</a> document to install `Node.js` and `npm`.
