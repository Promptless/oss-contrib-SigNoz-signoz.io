...
- A <a href="https://ai.google.dev/gemini-api/docs/libraries" target="_blank" rel="noopener noreferrer nofollow">Google Gemini</a> API account with a working API Key
