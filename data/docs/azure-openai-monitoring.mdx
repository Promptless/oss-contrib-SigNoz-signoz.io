...
- An <a href="https://azure.microsoft.com/en-us/pricing/purchase-options/azure-account/" target="_blank" rel="noopener noreferrer nofollow">Microsoft Azure</a> account with an OpenAI resource deployed and working API Key
...
The Azure OpenAI API uses an API format compatible with OpenAI. By modifying the configuration, you can use the OpenAI SDK or softwares compatible with the OpenAI API to access the Azure OpenAI API. Hence, a similar method to monitor OpenAI APIs can be used for monitoring Azure OpenAI APIs as well. To read more about this, you can read the <a href="https://learn.microsoft.com/en-us/azure/ai-foundry/openai/how-to/responses?tabs=python-key" target="_blank" rel="noopener noreferrer nofollow">Azure OpenAI API Docs</a>
