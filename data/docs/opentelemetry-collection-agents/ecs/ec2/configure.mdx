...
- <a href="https://github.com/SigNoz/dashboards/blob/main/ecs-infra-metrics/instance-metrics.json" target="_blank" rel="noopener noreferrer nofollow">instance-metrics.json</a>
- <a href="https://github.com/SigNoz/dashboards/blob/main/hostmetrics/hostmetrics.json" target="_blank" rel="noopener noreferrer nofollow">hostmetrics.json</a>
...
<Admonition>
This step include adding the <a href="https://opentelemetry.io/docs/instrumentation/" target="_blank" rel="noopener noreferrer nofollow">OpenTelemetry SDK</a>
