...
To override the default and use the node name, update your `values.yaml` for <a href="https://github.com/SigNoz/charts/blob/main/charts/k8s-infra/values.yaml#L354" target="_blank" rel="noopener noreferrer nofollow">presets.kubeletMetrics</a>:
