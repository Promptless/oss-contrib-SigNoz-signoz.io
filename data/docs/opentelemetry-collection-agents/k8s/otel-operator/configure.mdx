...
- See the upstream guide: <a href="https://opentelemetry.io/docs/platforms/kubernetes/operator/automatic/" target="_blank" rel="noopener noreferrer nofollow">Automatic instrumentation via the Operator</a>
