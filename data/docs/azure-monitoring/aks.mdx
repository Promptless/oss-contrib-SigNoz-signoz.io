...
<a href="https://learn.microsoft.com/en-us/azure/aks/what-is-aks" target="_blank" rel="noopener noreferrer nofollow">AKS (Azure Kubernetes Service)</a> is a managed Kubernetes service provided by Microsoft Azure that 
...
<a href="https://docs.px.dev/tutorials/integrations/otel/" target="_blank" rel="noopener noreferrer nofollow">Pixie OpenTelemetry Tutorial</a>
