...
3. <a href="https://learn.microsoft.com/en-us/azure/azure-sql/database/sql-insights-enable?view=azuresql#create-sql-monitoring-profile" target="_blank" rel="noopener noreferrer nofollow">SQL monitoring profile</a> created to monitor the databases in Azure Monitor
...
<Admonition>
Make sure you have created a sql monitoring profile in Azure Monitor if not, Follow this guide to <a href="https://learn.microsoft.com/en-us/azure/azure-sql/database/sql-insights-enable?view=azuresql#create-sql-monitoring-profile" target="_blank" rel="noopener noreferrer nofollow">Create SQL Monitoring Profile</a>.
