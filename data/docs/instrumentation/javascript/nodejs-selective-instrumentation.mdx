...
Use library names without the `@opentelemetry/instrumentation-` prefix. See the <a href="https://github.com/open-telemetry/opentelemetry-js-contrib/blob/main/packages/auto-instrumentations-node/README.md#supported-instrumentations" target="_blank" rel="noopener noreferrer nofollow">full list of supported libraries</a>.
