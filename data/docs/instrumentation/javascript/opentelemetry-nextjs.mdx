...
In <a href="https://nextjs.org/blog/next-15" target="_blank" rel="noopener noreferrer nofollow">Next.js 15</a>, the `instrumentation.js` API was promoted from experimental to stable. This means:
...
Check out the <a href="https://github.com/SigNoz/sample-nextjs-app" target="_blank" rel="noopener noreferrer nofollow">Sample Next.js App</a> for a complete working example.
