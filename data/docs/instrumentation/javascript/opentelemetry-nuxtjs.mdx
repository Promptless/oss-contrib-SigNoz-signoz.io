...
Check out the <a href="https://github.com/SigNoz/sample-nuxtjs-app" target="_blank" rel="noopener noreferrer nofollow">Sample Nuxt.js App</a> for a complete working example.
