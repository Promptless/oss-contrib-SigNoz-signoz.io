...
- Node.js version 18.0 or higher (see official list of <a href="https://github.com/open-telemetry/opentelemetry-js?tab=readme-ov-file#supported-runtimes" target="_blank" rel="noopener noreferrer nofollow">supported versions</a>)
