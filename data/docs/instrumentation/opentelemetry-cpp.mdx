...
- <a href="https://bazel.build/" target="_blank" rel="noopener noreferrer nofollow">Bazel</a>
...
To configure your C++ application to send traces to OpenTelemetry you need to install <a href="https://github.com/open-telemetry/opentelemetry-cpp.git" target="_blank" rel="noopener noreferrer nofollow">opentelemetry-cpp</a> and add it as dependency in your project.
