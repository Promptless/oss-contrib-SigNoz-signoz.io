...
- OpenTelemetry SDK installed via <a href="https://getcomposer.org/" target="_blank" rel="noopener noreferrer nofollow">Composer</a>:
  ```bash
...
Use <a href="https://opentelemetry.io/docs/specs/semconv/" target="_blank" rel="noopener noreferrer nofollow">semantic conventions</a> for common attributes when possible.
...
- Explore <a href="https://packagist.org/search/?query=open-telemetry&amp;tags=instrumentation" target="_blank" rel="noopener noreferrer nofollow">supported PHP instrumentation libraries</a> for automatic instrumentation of frameworks and libraries
