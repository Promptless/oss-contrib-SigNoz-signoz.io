...
- Flutter SDK installed; see the <a href="https://docs.flutter.dev/get-started/install" target="_blank" rel="noopener noreferrer nofollow">Flutter install guide</a>.
- Access to a SigNoz Cloud account or self-hosted SigNoz instance.

## Send traces to SigNoz

<Admonition type="info">
Test the sample app for <a href="https://github.com/SigNoz/mobile-monitoring-sample-apps/tree/main/android-ios-flutter" target="_blank" rel="noopener noreferrer nofollow">Flutter</a> (replace the variables inside `main.dart`).
</Admonition>
