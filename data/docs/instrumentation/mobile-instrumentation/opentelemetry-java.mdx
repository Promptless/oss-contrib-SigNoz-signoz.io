...
Test the sample app for <a href="https://github.com/SigNoz/mobile-monitoring-sample-apps/tree/main/android-java" target="_blank" rel="noopener noreferrer nofollow">Java</a>.
</Admonition>
