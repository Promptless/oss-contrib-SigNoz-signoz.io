...
- Kotlin toolchain installed; see the <a href="https://kotlinlang.org/docs/home.html" target="_blank" rel="noopener noreferrer nofollow">Kotlin documentation</a>.
- Access to a SigNoz Cloud account or self-hosted SigNoz instance.

## Send traces to SigNoz

<Admonition type="note">
Test the sample app for <a href="https://github.com/SigNoz/mobile-monitoring-sample-apps/tree/main/android-kotlin" target="_blank" rel="noopener noreferrer nofollow">Kotlin</a>.
</Admonition>
