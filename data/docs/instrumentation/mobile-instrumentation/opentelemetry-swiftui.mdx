...
- Swift toolchain installed; see <a href="https://www.swift.org/getting-started/#installing-swift" target="_blank" rel="noopener noreferrer nofollow">Swift getting started</a>.
- Access to a SigNoz Cloud account or self-hosted SigNoz instance.

## Send traces to SigNoz

<Admonition type="note">
You can test the sample app for <a href="https://github.com/SigNoz/mobile-monitoring-sample-apps/tree/main/ios-swift" target="_blank" rel="noopener noreferrer nofollow">SwiftUI</a>.
</Admonition>

### Step 1: Add OpenTelemetry dependencies

Install <a href="https://github.com/open-telemetry/opentelemetry-swift.git" target="_blank" rel="noopener noreferrer nofollow">opentelemetry-swift</a> and <a href="https://github.com/grpc/grpc-swift" target="_blank" rel="noopener noreferrer nofollow">grpc-swift</a> in `Package.swift`.
