...
- <a href="https://pecl.php.net/" target="_blank" rel="noopener noreferrer nofollow">PECL</a> package manager
- <a href="https://getcomposer.org/" target="_blank" rel="noopener noreferrer nofollow">Composer</a> dependency manager
...
>
    ...
    <LibraryTab value="php-fpm" label="PHP-FPM" category="runtime">
        ...
        See <a href="https://www.php.net/manual/en/install.fpm.configuration.php" target="_blank" rel="noopener noreferrer nofollow">PHP-FPM pool directives</a> for `clear_env` and `env[...]` details.
...
- Explore <a href="https://packagist.org/search/?query=open-telemetry&amp;tags=instrumentation" target="_blank" rel="noopener noreferrer nofollow">supported PHP instrumentation libraries</a> for automatic instrumentation of additional frameworks and libraries
