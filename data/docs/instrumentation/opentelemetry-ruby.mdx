...
We have included a sample Ruby application with README.md at <a href="https://github.com/SigNoz/sample-rails-app" target="_blank" rel="noopener noreferrer nofollow">Sample Rails App Github Repo</a>.
