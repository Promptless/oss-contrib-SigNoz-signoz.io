...
- <a href="https://developers.cloudflare.com/workers/wrangler/install-and-update/" target="_blank" rel="noopener noreferrer nofollow">Wrangler</a>, the CLI tool for Cloudflare.
...
Install `@microlabs/otel-cf-workers` in your <a href="https://developers.cloudflare.com/workers/get-started/guide/#1-create-a-new-worker-project" target="_blank" rel="noopener noreferrer nofollow">project</a>.
...
<Admonition type="info">
  <a href="https://www.npmjs.com/package/@microlabs/otel-cf-workers" rel="noopener noreferrer nofollow">@microlabs/otel-cf-workers</a> is a third
