...
For more detailed info on instrumenting your LiteLLM SDK applications click <a href="https://docs.litellm.ai/docs/observability/opentelemetry_integration" target="_blank" rel="noopener noreferrer nofollow">here</a>.
