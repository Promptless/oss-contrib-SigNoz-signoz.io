...
In the SigNoz version `>=v0.27` i.e. SigNoz chart version `>=v0.23.0`, <a href="https://clickhouse.com/" target="_blank" rel="noopener noreferrer nofollow">ClickHouse</a> is upgraded from version v22.8.8 to v23.7.3.
