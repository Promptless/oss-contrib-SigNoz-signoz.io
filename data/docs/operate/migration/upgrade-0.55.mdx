...
* In your <a href="https://github.com/SigNoz/signoz/blob/76e7de3aeda1f40c11d04f79e5973966b1c21789/deploy/docker/clickhouse-setup/docker-compose.yaml" target="_blank" rel="noopener noreferrer nofollow">docker-compose.yaml</a>, add the following: 
  ```
  query-service:
    command:
      [
  ...
  ```
* In your <a href="https://github.com/SigNoz/signoz/blob/76e7de3aeda1f40c11d04f79e5973966b1c21789/deploy/docker/clickhouse-setup/otel-collector-config.yaml" target="_blank" rel="noopener noreferrer nofollow">otel-collector-config.yaml</a>, add the following:
  ```
  exporters:
