...
- Review the <a href="https://github.com/SigNoz/signoz/releases" target="_blank" rel="noopener noreferrer nofollow">release notes</a> for any breaking changes
...
For more details, see the <a href="https://helm.sh/docs/helm/helm_upgrade/" target="_blank" rel="noopener noreferrer nofollow">Helm upgrade documentation</a>.
