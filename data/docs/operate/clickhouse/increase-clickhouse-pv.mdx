...
<a href="https://aws.amazon.com/eks/" target="_blank" rel="noopener noreferrer nofollow">AWS Elastic Kubernetes Service</a>.
</Admonition>
...
<a href="https://cloud.google.com/kubernetes-engine/" target="_blank" rel="noopener noreferrer nofollow">Google Kubernetes Engine</a>.
</Admonition>
...
to <a href="https://kubernetes.io/docs/setup/" target="_blank" rel="noopener noreferrer nofollow">Kubernetes Getting Started Guide</a>.
</Admonition>
...
1. You would have to edit default storage class i.e. `standard` in case of <a href="https://kind.sigs.k8s.io" target="_blank" rel="noopener noreferrer nofollow">kind cluster</a> - it could be different in your scenerio, and patch the `allowVolumeExpansion` to `true`.
