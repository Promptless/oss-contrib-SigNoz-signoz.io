...
Follow <a href="https://github.com/SigNoz/signoz/issues/6805" target="_blank" rel="noopener noreferrer nofollow">Issue#6805</a> on Github for an update on the implementation status of configuration options.
</Admonition>
...
For a comprehensive list of all available configuration options, refer to our <a href="https://github.com/SigNoz/signoz/blob/main/conf/example.yaml" target="_blank" rel="noopener noreferrer nofollow">example configuration file</a>. The file is continuously updated with new options as they are added.
