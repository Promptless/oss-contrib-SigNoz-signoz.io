...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/docs/elb/elb-logs-create_bucket_2.webp" alt="S3 bucket creation form with bucket name and region fields"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]"  src="/img/docs/elb/elb-logs-lambda_1.webp" alt="AWS Lambda Console showing Create function button"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/docs/vpc-docs/create_function.webp" alt="Lambda function creation form with Author from scratch option selected"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/docs/elb/elb-logs-lambda_3.webp" alt="Lambda runtime and permissions configuration options"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/docs/vpc-docs/lambda_function.webp" alt="Newly created Lambda function overview page"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/docs/vpc-docs/execution_role.webp" alt="Lambda function Configuration tab showing Permissions section"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/docs/vpc-docs/add_policy.webp" alt="IAM page showing Add permissions dropdown with Attach policies option"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/docs/elb/elb-logs-lambda_7.webp" alt="IAM Attach policies page with AmazonS3FullAccess policy selected"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/docs/elb/elb-logs-policies-used.webp" alt="List of IAM policies required for Lambda function execution"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/docs/vpc-docs/add_trigger.webp" alt="Lambda function console showing Add trigger button"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/docs/vpc-docs/add_trigger_2.webp" alt="S3 trigger configuration showing event type selection dropdown"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/docs/elb/elb-logs-layer_3.webp" alt="AWS Lambda Layers page with Create Layer button"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/docs/elb/elb-logs-layer_4.webp" alt="Layer configuration page with upload zip file option"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/docs/elb/elb-logs-layer_5.webp" alt="Lambda function Layers section with Add a layer button"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/docs/elb/elb-logs-layer_6.webp" alt="Add layer dialog showing Custom layers option and layer selection dropdown"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/docs/elb/elb-logs-timeout_increase.webp" alt="Lambda function General Configuration showing timeout setting"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/docs/elb/elb-logs-lambda_test_event.webp" alt="Lambda test event configuration dialog with S3 PUT event template"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/docs/elb/elb-logs-lambda_10.webp" alt="Lambda function code editor showing the VPC log forwarding code"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/docs/elb/elb-logs-lambda_output.webp" alt="Lambda function execution output showing successful log transmission"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/docs/elb/elb-logs-lambda_12.webp" alt="SigNoz Logs Explorer showing VPC Flow Logs with parsed network traffic fields"/>
