...
<Admonition type="tip">
You can add more Lambda metrics like `DeadLetterErrors`, `DestinationDeliveryFailures`, or `ProvisionedConcurrencyInvocations` as needed. See the <a href="https://docs.aws.amazon.com/lambda/latest/dg/monitoring-metrics-types.html" target="_blank" rel="noopener noreferrer nofollow">AWS Lambda metrics documentation</a> for a full list.
</Admonition>
