...
Refer <a href="https://aws.amazon.com/blogs/compute/using-aws-lambda-extensions-to-send-logs-to-custom-destinations/" target="_blank" rel="noopener noreferrer nofollow">this link</a> to know how to automatically collect Lambda logs in S3.
</Admonition>
...
We will be using python's `request` module which is <a href="https://aws.amazon.com/blogs/compute/upcoming-changes-to-the-python-sdk-in-aws-lambda/" target="_blank" rel="noopener noreferrer nofollow">not included by default</a> in Lambda.
