...
- **Metrics**: Import <a href="https://github.com/SigNoz/dashboards/tree/main/ecs-infra-metrics" target="_blank" rel="noopener noreferrer nofollow">ECS Infra Metrics</a> dashboards
