...
<Admonition>
Ensure <a href="https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/Container-Insights-setup-EKS.html" target="_blank" rel="noopener noreferrer nofollow">Container Insights</a> is enabled on your EKS cluster for metrics to be available.
</Admonition>
