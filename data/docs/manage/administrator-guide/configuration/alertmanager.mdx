...
We are working on introducing a unified configuration system that will allow setting these parameters globally through a single configuration. You can track the progress in <a href="https://github.com/SigNoz/signoz/issues/6805" target="_blank" rel="noopener noreferrer nofollow">#6805</a>.
</Admonition>
