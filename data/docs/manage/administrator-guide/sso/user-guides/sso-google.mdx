...
1. Visit the <a href="https://console.cloud.google.com/apis/credentials" target="_blank" rel="noopener noreferrer nofollow">Google Cloud Console → Credentials</a>
...
1. Go to <a href="https://console.cloud.google.com/iam-admin/serviceaccounts" target="_blank" rel="noopener noreferrer nofollow">Google Cloud Console → IAM & Admin → Service Accounts</a>
...
1. Go to <a href="https://admin.google.com/ac/owl/domainwidedelegation" target="_blank" rel="noopener noreferrer nofollow">Google Workspace Admin Console → Security → API Controls → Domain-wide Delegation</a>
2. Click **Add new**
...
1. Go to <a href="https://console.cloud.google.com/apis/library" target="_blank" rel="noopener noreferrer nofollow">Google Cloud Console → APIs & Services → Library</a>
