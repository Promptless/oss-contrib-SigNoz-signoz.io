...
This integration uses the **Webhook** notification channel. Select "Webhook" from the notification channel dropdown in the SigNoz UI, then configure it with Rootly's Prometheus Alertmanager webhook format.
</Admonition>
