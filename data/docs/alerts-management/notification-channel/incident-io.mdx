...
This integration uses the **Webhook** notification channel. Select "Webhook" from the notification channel dropdown in the SigNoz UI, then configure it with Incident.io's Prometheus Alertmanager webhook format.
</Admonition>
