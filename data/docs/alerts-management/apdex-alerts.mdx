...
description: Create alerts based on Apdex (Application Performance Index) scores to monitor user satisfaction and application performance against response time thresholds.
---
