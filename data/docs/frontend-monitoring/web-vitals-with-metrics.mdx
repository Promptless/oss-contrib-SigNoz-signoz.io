...
We have set up a <a href="https://github.com/SigNoz/frontend-monitoring-examples/tree/main/web-vitals-with-metrics" target="_blank" rel="noopener noreferrer nofollow">Demo React application</a> that demonstrates monitoring Core Web Vitals with metrics using OpenTelemetry and sending them to SigNoz.
