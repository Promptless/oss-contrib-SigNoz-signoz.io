...
<img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/docs/frontend-monitoring/document-load-services-section-image.webp" alt="SigNoz Services Interface"/>
...
<figure data-zoomable align='center'>
<img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/docs/frontend-monitoring/document-load-traces-section.webp" alt="Trace Data on Document Load"/>
...
<figure data-zoomable align='center'>
<img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/docs/frontend-monitoring/resource-fetch-alert-sample.webp" alt="Resource Alert Fetch Sample"/>
...
<figure data-zoomable align='center'>
<img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/docs/frontend-monitoring/define-the-metric.webp" alt="Define the Metric"/>
...
<figure data-zoomable align='center'>
<img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/docs/frontend-monitoring/alert-conditions.webp" alt="Set Alert Condition"/>
...
<figure data-zoomable align='center'>
<img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/docs/frontend-monitoring/alert-configuration.webp" alt="Set Alert Configuration"/>
...
<figure data-zoomable align='center'>
<img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/docs/frontend-monitoring/alert-rules.webp" alt="Alert Rules"/>
