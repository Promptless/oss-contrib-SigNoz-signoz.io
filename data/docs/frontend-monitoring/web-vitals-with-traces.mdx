...
We have set up a <a href="https://github.com/SigNoz/frontend-monitoring-examples/tree/main/web-vitals" target="_blank" rel="noopener noreferrer nofollow">Demo React application</a> that demonstrates monitoring Core Web Vitals with traces using OpenTelemetry and sending them to SigNoz.
