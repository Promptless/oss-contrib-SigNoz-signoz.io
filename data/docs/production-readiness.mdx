...
9. Use sampling to reduce the amount of data sent to SigNoz. See <a href="https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/main/processor/probabilisticsamplerprocessor" target="_blank" rel="noopener noreferrer nofollow">opentelemetry-collector-contrib/processor/probabilisticsamplerprocessor</a>
