...
SigNoz is OpenTelemetry-native and works with <a href="https://github.com/open-telemetry/opentelemetry-proto/blob/main/docs/specification.md" target="_blank" rel="noopener noreferrer nofollow">OpenTelemetry Protocol (OTLP)</a>. For self-hosted deployments, you typically send OTLP data directly to the SigNoz OpenTelemetry Collector that is installed with SigNoz, or to a collector you manage and then forward it to SigNoz.
