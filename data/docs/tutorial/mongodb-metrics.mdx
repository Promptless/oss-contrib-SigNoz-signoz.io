...
1. Clone this sample <a href="https://github.com/SigNoz/sample-fastapi-with-dbs#run-using-docker-compose" target="_blank" rel="noopener noreferrer nofollow">FastAPI application</a>
...
<a href="https://github.com/SigNoz/signoz/blob/main/deploy/docker/otel-collector-config.yaml" target="_blank" rel="noopener noreferrer nofollow">signoz/otel-collector-config.yaml</a>
...
Please ensure that the edited YAML is correctly configured. You can use tools like <a href="http://www.yamllint.com/" target="_blank" rel="noopener noreferrer nofollow">http://www.yamllint.com/</a> to check the correctness of the updated YAML file
...
<a href="https://www.mongodb.com/basics/how-to-monitor-mongodb-and-what-metrics-to-monitor" target="_blank" rel="noopener noreferrer nofollow">Good guide on metrics you may want to monitor</a>
...
<a href="https://grafana.com/grafana/dashboards/2583/revisions" target="_blank" rel="noopener noreferrer nofollow">https://grafana.com/grafana/dashboards/2583/revisions</a>
