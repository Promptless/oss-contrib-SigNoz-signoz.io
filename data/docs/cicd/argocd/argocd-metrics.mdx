...
```
Checkout this <a href="https://github.com/SigNoz/dashboards/blob/main/argocd/readme.md#configure-opentelemetry-collector" target="_blank" rel="noopener noreferrer nofollow">link</a> to see the complete configuration file.
...
1. Download the ArgoCD dashboard JSON from <a href="https://github.com/SigNoz/dashboards/blob/main/argocd/argocd.json" target="_blank" rel="noopener noreferrer nofollow">SigNoz Dashboards Repository</a>
...
To get a details about metrics in each section, follow this <a href="https://github.com/SigNoz/dashboards/blob/main/argocd/readme.md#sections" target="_blank" rel="noopener noreferrer nofollow">link</a>.
...
If you continue to experience issues, check the [SigNoz community forum](https://community-chat.signoz.io/) or <a href="https://github.com/SigNoz/signoz/issues" target="_blank" rel="noopener noreferrer nofollow">open an issue on GitHub</a> for further assistance.
