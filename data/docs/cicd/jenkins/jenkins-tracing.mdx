...
* For installing the plugin, please refer to <a href="https://plugins.jenkins.io/opentelemetry-agent-metrics/" target="_blank" rel="noopener noreferrer nofollow">this documentation</a>.
