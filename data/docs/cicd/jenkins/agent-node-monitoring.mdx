...
## Overview
<a href="https://www.jenkins.io/" target="_blank" rel="noopener noreferrer nofollow">Jenkins</a> is an automation server that enables developers to build, test, and deploy their applications through continuous integration and continuous delivery (CI/CD) pipelines. This document will help you monitor your Jenkins build agents' metrics using SigNoz.
...
* For installing the plugin, please refer to <a href="https://plugins.jenkins.io/opentelemetry-agent-metrics/#plugin-content-web-ui-install" target="_blank" rel="noopener noreferrer nofollow">this documentation</a>
...
More information about these executables and their setup can be found in this <a href="https://plugins.jenkins.io/opentelemetry-agent-metrics/#plugin-content-setup-the-executable-source" target="_blank" rel="noopener noreferrer nofollow">document</a>.
