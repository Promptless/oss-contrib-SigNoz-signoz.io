...
This guide walks you through setting up observability and monitoring for Mastra using <a href="https://opentelemetry.io/" target="_blank" rel="noopener noreferrer nofollow">OpenTelemetry</a> and exporting traces to SigNoz. With this integration, you can observe model performance, capture request/response details, giving you real-time visibility into latency, error rates, and usage trends for your Mastra applications.
...
You can get the full Mastra installation instructions <a href="https://mastra.ai/en/docs/getting-started/installation" target="_blank" rel="noopener noreferrer nofollow">here</a>.
