...
We will be using the <a href="https://api.telemetry.confluent.cloud/docs#tag/Version-2" target="_blank" rel="noopener noreferrer nofollow">Confluent Cloud Metrics API(V2)</a> to collect the Confluent Cloud metrics. 
...
Go to <a href="https://www.confluent.io/get-started/" target="_blank" rel="noopener noreferrer nofollow">Confluent Get Started</a> page, and select **SELF-MANAGED**. Fill in the appropriate details, and click on **Download Free**.
