...
2. **Amazon MSK**: You will need an Amazon MSK cluster to monitor. If you don't have one, you can create one using the <a href="https://docs.aws.amazon.com/msk/latest/developerguide/create-cluster.html" target="_blank" rel="noopener noreferrer nofollow">Amazon MSK console</a>.
