...
description: Monitoring and observability for n8n usage and performance with OpenTelemetry instrumentation to send traces, logs, and metrics to SigNoz
doc_type: howto
---
...
OTEL_EXPORTER_OTLP_HEADERS=signoz-ingestion-key=your_signoz_key_here
...
You can also check out our custom n8n dashboard [here](https://signoz.io/docs/dashboards/dashboard-templates/n8n-dashboard/) which provides specialized visualizations for monitoring your n8n usage in applications. The dashboard includes pre-built charts specifically tailored for LLM usage, along with import instructions to get started quickly.
