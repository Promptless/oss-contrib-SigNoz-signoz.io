...
Please refer to the <a href="https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/main/processor/probabilisticsamplerprocessor" target="_blank" rel="noopener noreferrer nofollow">OpenTelemetry documentation</a> for more details on how to configure the probabilistic sampling processor and <a href="https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/main/processor/tailsamplingprocessor" target="_blank" rel="noopener noreferrer nofollow">OpenTelemetry documentation</a> for more details on how to configure the tail sampling processor.
