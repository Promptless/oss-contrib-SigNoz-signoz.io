...
For more details on metrics, see the <a href="https://supabase.com/docs/guides/telemetry/metrics#supabase-grafana" target="_blank" rel="noopener noreferrer nofollow">Supabase metrics documentation</a>.
...
service:
  ...
  pipelines:
    metrics:
      ...
      exporters: [otlp]
```
- `<YOUR_SUPABASE_SERVICE_ROLE_JWT>`: Replace this with your Supabase project's Service Role JWT, which you can find in your <a href="https://supabase.com/dashboard/project/_/settings/api-keys" target="_blank" rel="noopener noreferrer nofollow">Supabase dashboard</a>.
