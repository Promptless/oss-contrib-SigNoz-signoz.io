...
<Tabs>
    ...
    <TabItem value="k8s" label="Kubernetes">
        ...
        1. <a href="https://github.com/SigNoz/samples-server/blob/main/cloud/observability/promql-to-scrape/examples/deployment.yaml" target="_blank" rel="noopener noreferrer nofollow">Deployment</a>. Configure <a href="https://github.com/SigNoz/samples-server/blob/main/cloud/observability/promql-to-scrape/examples/deployment.yaml#L21-L24" target="_blank" rel="noopener noreferrer nofollow">these</a> args to your environment
        2. <a href="https://github.com/SigNoz/samples-server/blob/main/cloud/observability/promql-to-scrape/examples/configmap.yaml" target="_blank" rel="noopener noreferrer nofollow">ConfigMap</a>
        3. <a href="https://github.com/SigNoz/samples-server/blob/main/cloud/observability/promql-to-scrape/examples/secret.yaml" target="_blank" rel="noopener noreferrer nofollow">Secret</a>. Add your cert and key <a href="https://github.com/SigNoz/samples-server/blob/main/cloud/observability/promql-to-scrape/examples/secret.yaml#L9-L10" target="_blank" rel="noopener noreferrer nofollow">here</a>
...
Download JSON from <a href="https://github.com/SigNoz/dashboards/blob/main/temporal.io/Temporal%20Cloud%20Metrics.json" target="_blank" rel="noopener noreferrer nofollow">link</a>
