...
All the available Snowflake receiver configurations can be found <a href="https://github.com/open-telemetry/opentelemetry-collector-contrib/blob/main/receiver/snowflakereceiver/config.go" target="_blank" rel="noopener noreferrer nofollow">here</a>.
...
Download JSON from <a href="https://github.com/SigNoz/dashboards/blob/main/snowflake/snowflake-otlp-v1.json" target="_blank" rel="noopener noreferrer nofollow">link</a>.
...
You can refer <a href="https://github.com/open-telemetry/opentelemetry-collector-contrib/blob/main/receiver/snowflakereceiver/documentation.md" target="_blank" rel="noopener noreferrer nofollow">this</a> page for more details about the Snowflake metrics.
