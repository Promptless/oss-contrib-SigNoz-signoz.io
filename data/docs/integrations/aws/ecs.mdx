...
When **AWS Container Insights is <a href="https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/deploy-container-insights-ECS-cluster.html" target="_blank" rel="noopener noreferrer nofollow">enabled</a>** for your ECS resources, this integration also collects enhanced metrics including:
