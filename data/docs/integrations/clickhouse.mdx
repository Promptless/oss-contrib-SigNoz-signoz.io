...
You can also manually create the above Clickhouse Dashboard by importing the JSON file available <a href="https://github.com/SigNoz/signoz/blob/a5d58008713c23431fba26200a68ce7d9fc49e1e/pkg/query-service/app/integrations/builtin_integrations/clickhouse/assets/dashboards/overview.json" target="_blank" rel="noopener noreferrer nofollow">here</a>.
...
To find a complete list of metrics you can checkout this <a href="https://github.com/SigNoz/signoz/blob/a5d58008713c23431fba26200a68ce7d9fc49e1e/pkg/query-service/app/integrations/builtin_integrations/clickhouse/data-collected.json" target="_blank" rel="noopener noreferrer nofollow">link</a>
