...
date: 2026-03-30
id: trace
description: Learn how to use SigNoz log pipelines to parse trace information from log records and correlate logs with corresponding traces.
...
<figure data-zoomable align="center">
  <img
    src="/img/logs/pipelines/pipeline-preview-processed.webp"
...
<figure data-zoomable align="center">
  <img
    src="/img/logs/pipelines/save-trace-parsing-pipeline.webp"
