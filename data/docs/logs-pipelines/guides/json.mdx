...
date: 2026-03-30
id: json
description: Learn how to use SigNoz log pipelines to parse JSON-serialized log bodies into structured attributes for filtering and analysis.
...
<figure data-zoomable align="center">
  <img
    src="/img/logs/pipelines/save-json-parsing-pipeline.webp"
