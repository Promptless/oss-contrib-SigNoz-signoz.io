...
<img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/docs/logs-management/logs-pipelines/nested-json-guide-step1.webp" alt="Converting to Structured Attributes"/>
...
<figure data-zoomable align='center'>
<img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/docs/logs-management/logs-pipelines/nested-json-guide-step2.webp" alt="Extract Image Name to Attributes"/>
