...
Below is an `index.js` file of a <a href="https://github.com/SigNoz/nodejs-lambda" target="_blank" rel="noopener noreferrer nofollow">sample app</a>. This example demonstrates how to create a trace span, emit a custom log 
...
Check <a href="https://github.com/open-telemetry/opentelemetry-lambda/releases" target="_blank" rel="noopener noreferrer nofollow">OpenTelemetry Lambda releases</a> for the latest version.
