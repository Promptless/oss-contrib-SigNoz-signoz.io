...
This document explains how to collect log data from <a href="https://github.com/sirupsen/logrus" target="_blank" rel="noopener noreferrer nofollow">Logrus</a> and visualise it in [SigNoz](https://signoz.io/).
