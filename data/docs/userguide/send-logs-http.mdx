...
The payload is an array of logs in JSON format. It follows a structure similar to <a href="https://opentelemetry.io/docs/specs/otel/logs/data-model/" target="_blank" rel="noopener noreferrer nofollow">OTEL Logs Data Model</a>.
...
| `trace_flags`  | <a href="https://www.w3.org/TR/trace-context/#trace-flags" target="_blank" rel="noopener noreferrer nofollow">W3C</a> trace flag |
...
To know more details about the different fields in a log record, you can check <a href="https://opentelemetry.io/docs/specs/otel/logs/data-model/#log-and-event-record-definition" target="_blank" rel="noopener noreferrer nofollow">this documentation</a>.
