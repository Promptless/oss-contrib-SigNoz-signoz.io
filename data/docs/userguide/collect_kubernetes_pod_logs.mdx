...
To filter logs using <a href="https://github.com/open-telemetry/opentelemetry-collector-contrib/blob/main/pkg/stanza/docs/types/expression.md" target="_blank" rel="noopener noreferrer nofollow">expression</a>, you need to 
...
This filters logs matching the expression and drops them entirely. Learn more about the filter operator <a href="https://github.com/open-telemetry/opentelemetry-collector-contrib/blob/main/pkg/stanza/docs/operators/filter.md" target="_blank" rel="noopener noreferrer nofollow">here</a>.
