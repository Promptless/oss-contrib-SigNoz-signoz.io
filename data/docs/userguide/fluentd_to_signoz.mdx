...
2. **Configure FluentForward Receiver**
   ...
   ```
  You can change the port if needed. Learn more about the `fluentforward` receiver <a href="https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/main/receiver/fluentforwardreceiver" target="_blank" rel="noopener noreferrer nofollow">here</a>.
