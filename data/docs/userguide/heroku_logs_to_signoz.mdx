...
If you are running your applications on **Heroku**, you can stream logs to **SigNoz** using <a href="https://devcenter.heroku.com/articles/log-drains#https-drains" target="_blank" rel="noopener noreferrer nofollow">httpsdrain</a>.
