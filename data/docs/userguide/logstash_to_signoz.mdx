...
2. **Configure the Receiver**
   ...
   - Learn more about the `tcplog` receiver <a href="https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/main/receiver/tcplogreceiver" target="_blank" rel="noopener noreferrer nofollow">here</a>.
