...
2. **Add FluentForward receiver to your `config.yaml`:**
    ...
    ```
    Here, port 24224 is used for listening to the FluentForward protocol. You can change it to a port of your choice. Learn more about the FluentForward receiver <a href="https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/main/receiver/fluentforwardreceiver" target="_blank" rel="noopener noreferrer nofollow">here</a>.
...
6. **Use processors to transform logs:**
    ...
    To properly transform your existing log model into the OpenTelemetry <a href="https://github.com/open-telemetry/opentelemetry-specification/blob/main/specification/logs/data-model.md" target="_blank" rel="noopener noreferrer nofollow">log model</a>, use OpenTelemetry processors:
...
1. **Add FluentForward receiver to `otel-collector-config.yaml`:**
    ...
    receivers:
      fluentforward:
        endpoint: 0.0.0.0:24224
    ```
    Port 24224 is used for the FluentForward protocol. You can change it to a preferred port. Learn more about the FluentForward receiver <a href="https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/main/receiver/fluentforwardreceiver" target="_blank" rel="noopener noreferrer nofollow">here</a>.
...
6. **Use processors to transform logs:**
    ...
    To transform your existing log model into the OpenTelemetry <a href="https://github.com/open-telemetry/opentelemetry-specification/blob/main/specification/logs/data-model.md" target="_blank" rel="noopener noreferrer nofollow">log model</a>, use processors:
