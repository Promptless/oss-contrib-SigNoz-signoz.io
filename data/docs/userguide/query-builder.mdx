...
<figure data-zoomable align='center'>
<img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/docs/product-features/query-builder/temporal-spatial-aggregations.webp" alt="Spatial & temporal aggregations in the metrics query builder of SigNoz"/>
...
<figure data-zoomable align='center'>
<img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/docs/product-features/query-builder/support-for-functions.webp" alt="Functions in metrics query builder"/>
...
<figure data-zoomable align='center'>
<img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" width='80%' src="/img/docs/product-features/query-builder/chain-two-functions.webp" alt="Chained functions"/>
...
<figure data-zoomable align='center'>
<img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" width='80%' src="/img/docs/product-features/query-builder/time-shift.webp" alt="Time Shift function"/>
...
<figure data-zoomable align='center'>
<img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/docs/product-features/query-builder/plot-time-shift-charts.webp" alt="Compare performance of services"/>
