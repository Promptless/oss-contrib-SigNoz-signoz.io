...
<Admonition>
The queries should have a result column with the name `value` and a column with type <a href="https://clickhouse.com/docs/en/sql-reference/data-types/datetime" target="_blank" rel="noopener noreferrer nofollow">DateTime</a> for the graphs to work.
</Admonition>
