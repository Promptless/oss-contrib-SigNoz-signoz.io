...
description: Learn how to use alerts in SigNoz to monitor application performance.
title: Alerts 
---
...
<figure data-zoomable align='center'>
    <img src="/img/docs/repeat-notification.webp" alt="Repeat Notification configuration showing interval and condition options"/>
    <figcaption><i>Repeat Notification configuration</i></figcaption>
</figure>
