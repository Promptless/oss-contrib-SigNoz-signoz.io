...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/docs/apm-and-distributed-tracing/tarce-details-overview.webp" alt="Trace Details Interface"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/docs/apm-and-distributed-tracing/trace-details-span-details.webp" alt="Span Details"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/docs/apm-and-distributed-tracing/trace-details-filters.webp" alt="Filtering for error spans"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/docs/apm-and-distributed-tracing/trace-details-ui-adjustments.webp" alt="Resize Span names and Jump through spans"/>
