...
SigNoz supports all the receivers that are listed in the <a href="https://opentelemetry.io/ecosystem/registry/?component=receiver" target="_blank" rel="noopener noreferrer nofollow">OpenTelemetry Registry</a>. To configure a new metric receiver, follow these instructions [here](https://signoz.io/docs/userguide/otel-metrics-receivers/#steps).
