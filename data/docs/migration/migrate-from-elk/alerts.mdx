...
If you managed ELK alerts with Terraform or ElastAlert YAMLs, you can use the <a href="https://registry.terraform.io/providers/SigNoz/signoz/latest/docs" target="_blank" rel="noopener noreferrer nofollow">SigNoz Terraform Provider</a> to manage SigNoz alerts as code.
