...
1. **Find Template**
   Browse the <a href="https://github.com/SigNoz/dashboards" target="_blank" rel="noopener noreferrer nofollow">SigNoz Dashboard Templates repository</a> to find a matching dashboard (e.g., Host Metrics, Kubernetes, Nginx, Redis).
...
You can manage your dashboards as code using the <a href="https://registry.terraform.io/providers/SigNoz/signoz/latest/docs" target="_blank" rel="noopener noreferrer nofollow">SigNoz Terraform Provider</a>. This allows you to version control your dashboards, similar to managing Kibana objects.
