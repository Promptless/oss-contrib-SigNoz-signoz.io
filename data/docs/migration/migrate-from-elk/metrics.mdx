...
| **Other Modules** | Various         | Check <a href="https://opentelemetry.io/ecosystem/registry/?component=receiver" target="_blank" rel="noopener noreferrer nofollow">OTel Registry</a> to configure [OTel receivers](https://signoz.io/docs/userguide/otel-metrics-receivers/) |
...
Use the <a href="https://opentelemetry.io/ecosystem/registry/" target="_blank" rel="noopener noreferrer nofollow">OpenTelemetry Registry</a> to find exact metric names for each receiver.
