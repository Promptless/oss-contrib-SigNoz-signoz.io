...
You can manage your dashboards as code using the <a href="https://registry.terraform.io/providers/SigNoz/signoz/latest/docs" target="_blank" rel="noopener noreferrer nofollow">SigNoz Terraform Provider</a>. This allows you to version control your dashboards and automate their deployment, similar to how you might manage New Relic dashboards with Terraform.
