...
For more detailed info on tracing your Semantic Kernel applications click <a href="https://learn.microsoft.com/en-us/semantic-kernel/concepts/enterprise-readiness/observability/telemetry-with-console?tabs=Bash-CreatFile%2CBash-EnvironmentVariable&amp;pivots=programming-language-python" target="_blank" rel="noopener noreferrer nofollow">here</a>.
For more detailed info on Semantic Kernel telemetry data click <a href="https://learn.microsoft.com/en-us/semantic-kernel/concepts/enterprise-readiness/observability/?pivots=programming-language-python" target="_blank" rel="noopener noreferrer nofollow">here</a>.
