...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/04/newrelic-vs-sentry-cover.webp" alt=""/>
</figure>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/04/newrelic-vs-sentry-error-box-nr.webp" alt="Errors Inbox in New Relic"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/04/newrelic-vs-sentry-error-integration-nr.webp" alt="Errors Inbox integration with New Relic’s APM"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/04/newrelic-vs-sentry-error-insights-nr.webp" alt="Insights into error details with New Relic’s APM"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/04/newrelic-vs-sentry-list-of-issues-sentry.webp" alt="List of issues/errors coming from my application in Sentry"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/04/newrelic-vs-sentry-connection-error-sentry.webp" alt="Detailed Sentry insights into the “ConnectionError” issue"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/04/newrelic-vs-sentry-error-line-sentry.webp" alt="Sentry identifies the line of code causing issues"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/04/newrelic-vs-sentry-apm-nr.webp" alt="Python application being monitored in New Relic APM"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/04/newrelic-vs-sentry-tracing-nr.webp" alt="Tracing information from my application in New Relic’s APM"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/04/newrelic-vs-sentry-apm-sentry.webp" alt="Performance overview of application frontend in Sentry"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/04/newrelic-vs-sentry-log-nr.webp" alt="Log management in New Relic"/>
