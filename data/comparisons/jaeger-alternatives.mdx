...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/02/jaeger-alternatives-cover.webp" alt="Jaeger Alternatives cover image"/>
</figure>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/common/signoz_flamegraphs.webp" alt="Traces represented as Flamegraphs and Gantt charts in SigNoz dashbaord"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/common/traces_custom_aggregates.webp" alt="Run aggregates on trace data"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/02/jaeger-alternatives-honeycomb.webp" alt="Honeycomb observability dashboard"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/02/jaeger-alternatives-tempo.webp" alt="Tracing dashboard"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/02/jaeger-alternatives-datadog.webp" alt="Distributed tracing flame graphs"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/02/jaeger-alternatives-new-relic.webp" alt="Distributed tracing"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/02/jaeger-alternatives-aspecto.webp" alt="Trace analysis"/>
