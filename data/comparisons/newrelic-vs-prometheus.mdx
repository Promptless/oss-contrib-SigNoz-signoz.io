...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/02/new-relic-vs-prometheus-cover.webp" alt=""/>
</figure>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/02/newrelic-vs-prometheus-data-collection-nr.webp" alt="Data collection in New Relic"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/02/newrelic-vs-prometheus-http-metrics.webp" alt="Prometheus scraping metrics from HTTP endpoints"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/02/newrelic-vs-prometheus-dashboard-nr.webp" alt="Dashboard creation in New Relic"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/02/newrelic-vs-prometheus-graph.webp" alt="Graph visualization in Prometheus"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/02/newrelic-vs-prometheus-apm-nr.webp" alt="APM in New Relic"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/02/newrelic-vs-prometheus-nrql.webp" alt="Data query in New Relic using NRQL"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/02/newrelic-vs-prometheus-promql.webp" alt="Query in Prometheus using PromQL"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/02/newrelic-vs-prometheus-alert-nr.webp" alt="Alerting in New Relic"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/02/newrelic-vs-prometheus-alertmanager.webp" alt="Received alert from Prometheus in Alertmanager"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/02/newrelic-vs-prometheus-ui-nr.webp" alt="New Relic’s UI"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/02/newrelic-vs-prometheus-ui-prom.webp" alt="Prometheus UI"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/02/newrelic-vs-prometheus-pricing-nr.webp" alt="New Relic pricing"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/02/newrelic-vs-prometheus-pricing-nr-2.webp" alt="Pricing tiers"/>
