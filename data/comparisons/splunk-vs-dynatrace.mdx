...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/03/splunk-vs-dynatrace-cover.webp" alt=""/>
</figure>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/03/splunk-vs-dynatrace-tracing-splunk.webp" alt="Tag-based grouping of traces"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/03/splunk-vs-dynatrace-traces-captured.webp" alt="Captured traces in Dynatrace"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/03/splunk-vs-dynatrace-log-observer.webp" alt="Log Observer in Splunk"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/03/splunk-vs-dynatrace-log.webp" alt="Log management in Dynatrace"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/03/splunk-vs-dynatrace-security.webp" alt="Security monitoring in Splunk"/>
