...
This single-signal focus is both a strength and a limitation. Prometheus excels at metric collection and analysis. PromQL lets you slice, aggregate, and compare time series in ways that <a href="https://docs.aws.amazon.com/efs/latest/ug/monitoring-metric-math.html" target="_blank" rel="noopener noreferrer nofollow">CloudWatch's metric math</a> cannot match. But during an incident, you will inevitably need to context-switch to other tools for logs and traces.
...
A user on <a href="https://www.reddit.com/r/devops/comments/1r2so5d/" target="_blank" rel="noopener noreferrer nofollow">r/devops</a> shared that serverless log ingestion in CloudWatch accounted for 50% of their total monthly bill:
