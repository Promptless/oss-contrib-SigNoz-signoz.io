...
ServiceNow recently announced the <a href="https://docs.lightstep.com/changelog/eol-notice#heres-what-you-need-to-know" target="_blank" rel="noopener noreferrer nofollow">end-of-life (EOL) for Lightstep</a>, now known as Cloud Observability. Support will officially end on **March 1, 2026**, or at the end of your contract, and ServiceNow has confirmed there will be no direct replacement or migration path.
...
* **OpenTelemetry Support:** New Relic offers excellent support for OpenTelemetry, allowing you to send data via OTLP without using their proprietary agents. However, it's important to understand that the platform is **OTel-compatible, not OTel-native**. It ingests and translates OpenTelemetry data into its <a href="https://docs.newrelic.com/docs/opentelemetry/best-practices/opentelemetry-best-practices-metrics/" target="_blank" rel="noopener noreferrer nofollow">internal proprietary format.</a>
