...
### Datadog
<Figure src="/images/comparisons/09/best-infrastructure-monitoring-tools-datadog.png" alt="Datadog Infrastructure Monitoring Dashboard" caption="Datadog Infrastructure Monitoring Dashboard (Credits: Datadog)" width="724" height="400" />
