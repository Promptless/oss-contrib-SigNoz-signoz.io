...
You can instrument your application with OpenTelemetry and <a href="https://docs.aws.amazon.com/xray/latest/devguide/xray-services-adot.html" target="_blank" rel="noopener noreferrer nofollow">export telemetry data to AWS X-Ray</a> using the AWS Distro for OpenTelemetry (ADOT).
