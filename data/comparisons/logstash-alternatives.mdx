...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/05/logstash-alternatives-cover.webp" alt=""/>
</figure>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/05/logstash-alternatives-signoz.webp" alt="SigNoz Logs Dashboard (Source: SigNoz Website)"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/05/logstash-alternatives-graylog.webp" alt="Graylog Dashboard (Source: Graylog Website)"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/05/logstash-alternatives-beats.webp" alt="Beats  Visualization in Kibana (Source: Elastic Search)"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/05/logstash-alternatives-splunk.webp" alt="Splunk Logs Dashboard (Source: Splunk Website)"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/05/logstash-alternatives-atatus.webp" alt="Atatus Dashboard (Source: Atatus)"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/05/logstash-alternatives-rsyslog.webp" alt="Rsyslog  Logs Visualization (Source: Elastic Search)"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/05/logstash-alternatives-syslog.webp" alt="Syslog  Logs Visualization (Source: BMC)"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/05/logstash-alternatives-fluentd.webp" alt="Fluentd  Logs Dashboard (Source: Fluentd)"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/05/logstash-alternatives-newrelic.webp" alt="New Relic  Logs Dashboard (Source: New Relic)"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/05/logstash-alternatives-datadog.webp" alt="Datadog Logs Dashboard (Source: Datadog)"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/05/logstash-alternatives-memzo.webp" alt="Memzo Dashboard (Source: Memzo)"/>
