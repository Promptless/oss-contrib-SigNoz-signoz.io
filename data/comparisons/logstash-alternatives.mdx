...
- The biggest drawback of using Logstash is its resource-intensiveness. Logstash uses much more memory compared to other log shippers and [open source logging tools](https://signoz.io/blog/best-open-source-log-management-tools/#6-logstash---powerful-log-processing-engine), and this makes it unsuitable to handle large volumes of data as it leads to performance overhead.
