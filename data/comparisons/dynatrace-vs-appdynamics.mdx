...
SigNoz is available both as an <a href="https://github.com/SigNoz/signoz" target="_blank" rel="noopener noreferrer nofollow">open-source software</a> and a [cloud offering](https://signoz.io/teams/). Its usage-based pricing model ensures that businesses only pay for the resources they consume, with transparent and predictable pricing policies in place.
