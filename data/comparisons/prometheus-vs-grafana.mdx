...
<img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/02/prometheus-vs-grafana-cover.webp" alt=""/>
</figure>
...
<figure data-zoomable align='center'>
<img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/02/prometheus-vs-grafana-http-endpoints.webp" alt="HTTP endpoints Prometheus is scraping metrics from"/>
...
<figure data-zoomable align='center'>
<img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/02/prometheus-vs-grafana-datasources.webp" alt="Data sources in Grafana"/>
...
<figure data-zoomable align='center'>
<img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/02/prometheus-vs-grafana-table-visualization.webp" alt="Table visualization in Prometheus"/>
<figcaption><i>Table visualization</i></figcaption>
</figure>

<figure data-zoomable align='center'>
<img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/02/prometheus-vs-grafana-graph-visualisation.webp" alt="Graph visualization in Prometheus"/>
...
<figure data-zoomable align='center'>
<img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/02/prometheus-vs-grafana-visualization-suggestion.webp" alt="Visualization suggestion in Grafana"/>
...
<figure data-zoomable align='center'>
<img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/02/prometheus-vs-grafana-mysql-dashboard.webp" alt="MySQL database dashboard in Grafana"/>
...
<figure data-zoomable align='center'>
<img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/02/prometheus-vs-grafana-log.webp" alt="Log management with Loki in Grafana"/>
...
<figure data-zoomable align='center'>
<img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/02/prometheus-vs-grafana-promql.webp" alt="Query in Prometheus using PromQL"/>
...
<figure data-zoomable align='center'>
<img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/02/prometheus-vs-grafana-promql-in-grafana.webp" alt="PromQL queries in Grafana with Prometheus as datasource"/>
...
<figure data-zoomable align='center'>
<img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/02/prometheus-vs-grafana-sql-in-grafana.webp" alt="SQL query in Grafana with MySQL as data source"/>
...
<figure data-zoomable align='center'>
<img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/02/prometheus-vs-grafana-alerts.webp" alt="Alerts in Prometheus"/>
...
<figure data-zoomable align='center'>
<img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/02/prometheus-vs-grafana-alertmanager.webp" alt="Triggered alerts sent to Alertmanager from Prometheus"/>
...
<figure data-zoomable align='center'>
<img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/02/prometheus-vs-grafana-alert-rules.webp" alt="Alert rules in Grafana"/>
...
<figure data-zoomable align='center'>
<img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/02/prometheus-vs-grafana-prometheus-ui.webp" alt="Prometheus UI"/>
...
<figure data-zoomable align='center'>
<img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/02/prometheus-vs-grafana-ui-grafana.webp" alt="Grafana UI"/>
...
<figure data-zoomable align='center'>
<img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/06/signoz-thumbnail.webp" alt="SigNoz Thumbnail"/>
