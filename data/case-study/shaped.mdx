...
Backed by Y Combinator, <a href="https://www.shaped.ai/" target="_blank" rel="noopener noreferrer nofollow">Shaped</a> empowers companies to build production-ready ranking and recommendation models in minutes. Customers use Shaped’s powerful APIs to create personalized feed experiences for their users. The platform runs on a modern tech stack, hosted on AWS and orchestrated with Kubernetes (EKS).
...
We sat down with <a href="https://www.linkedin.com/in/karllyons/" target="_blank" rel="noopener noreferrer nofollow">Karl Lyons</a>, a senior site reliability engineer at Shaped, to understand how the engineering team at Shaped is leveraging SigNoz for observability.
