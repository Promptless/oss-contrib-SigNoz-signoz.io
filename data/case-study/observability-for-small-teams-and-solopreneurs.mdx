...
<div className="flex items-center gap-4">
  <a href="https://www.linkedin.com/in/makeavish/" className="block">
    <img alt="Vishal Profile" src="/img/authors/vishal-new.jpeg" className="h-12 w-12 rounded-full" />
  </a>
  <div className="flex flex-col gap-1">
    <div className="font-bold">Vishal Sharma</div>
