...
<div className="flex flex-wrap">
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      ...
      <a
         href="https://github.com/wayne666" className="block">
         <img
            alt="Wayne Zhou"
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Wayne Zhou</div>
    ...
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/swagftw" className="block">
         <img
            alt="Swapnil Nakade"
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Swapnil Nakade</div>
         <small className="text-sm text-signoz_vanilla-400">
         </small>
      </div>
      </div>
...
<div className="flex flex-wrap">
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/adnanrahic" className="block">
         <img
            alt="Adnan Rahić"
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Adnan Rahić</div>
         <small className="text-sm text-signoz_vanilla-400">
         </small>
      </div>
      </div>
