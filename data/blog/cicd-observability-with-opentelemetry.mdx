...
To make GitHub Actions observable with OTel, we leverage a component of the OTel Collector known as the <a href="https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/main/receiver/githubreceiver" target="_blank" rel="noopener noreferrer nofollow">*GitHub Receiver*</a>. This receiver can do some very cool things like,
...
For metrics, if you want to scrape data from the GitHub API, you'll need an access token with permissions to read repo and workflow data. You can read this <a href="https://docs.github.com/en/authentication/keeping-your-account-and-data-secure/managing-your-personal-access-tokens#creating-a-personal-access-token-classic" target="_blank" rel="noopener noreferrer nofollow">guide</a> to understand how to get your personal access token.
...
You can configure your collector to send data to any backend you choose by adding it to the exporters field. We are sending data to SigNoz for this example, <a href="https://www.reddit.com/r/opensource/comments/zlkb6y/we_are_framasoft_we_develop_peertube_and_promote/" target="_blank" rel="noopener noreferrer nofollow">you can find the instructions here</a>.
...
To view metrics in SigNoz, you can use this <a href="https://github.com/SigNoz/dashboards/blob/main/cicd/cicd.json" target="_blank" rel="noopener noreferrer nofollow">dashboard</a>.
