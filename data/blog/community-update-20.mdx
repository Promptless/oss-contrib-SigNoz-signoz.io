...
<div className="flex flex-wrap">
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      ...
      <a
         href="https://github.com/gzsombor" className="block">
         <img
            alt="Zsombor"
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Zsombor</div>
   ...
   <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/mariuskimmina" className="block">
         <img
            alt="Marius Kimmina"
         ...
         <div className="flex flex-col gap-1">
            <div className="font-bold">Marius Kimmina</div>
            <small className="text-sm text-signoz_vanilla-400"></small>
         </div>
      </div>
   </div>
   ...
   <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/mikeatm" className="block">
         <img
            alt="Michael"
