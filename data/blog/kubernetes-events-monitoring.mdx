...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2023/12/kubernetes-events-monitoring-logs-tab.webp" alt="Kubernetes events monitoring - Logs of K8s events in SigNoz"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2023/12/kubernetes-events-monitoring-metrics.webp" alt="Kubernetes events monitoring - Dashboard for monitoring kubernetes events"/>
