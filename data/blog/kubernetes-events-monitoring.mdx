...
<figure data-zoomable align='center'>
    <OptimizedImg className="box-shadowed-image" src="/img/blog/2023/12/kubernetes-events-monitoring-logs-tab.webp" alt="Kubernetes events monitoring - Logs of K8s events in SigNoz"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg className="box-shadowed-image" src="/img/blog/2023/12/kubernetes-events-monitoring-metrics.webp" alt="Kubernetes events monitoring - Dashboard for monitoring kubernetes events"/>
