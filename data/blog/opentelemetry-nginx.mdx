...
<OptimizedImg src="/img/blog/2023/02/architecture_nginx_backend_signoz.webp" alt="Architecture of the setup consisting of nginx, backend and SigNoz"/>
...
<figure data-zoomable align='center'>
<OptimizedImg src="/img/blog/2023/02/nginx_go_services.webp" alt="nginx and go backend in the list of applications monitored on SigNoz"/>
...
<figure data-zoomable align='center'>
<OptimizedImg src="/img/blog/2023/02/nginx_traces.webp" alt="Traces on SigNoz dashboard"/>
...
<figure data-zoomable align='center'>
<OptimizedImg src="/img/blog/2023/02/nginx_500_traces.webp" alt="spans with http status codes in attributes"/>
...
<figure data-zoomable align='center'>
<OptimizedImg src="/img/blog/2023/02/nginx_200_traces.webp" alt="spans with http status codes in attributes"/>
