...
<div className="flex flex-wrap">
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      ...
      <a
         href="https://github.com/himanshugupta714" className="block">
         <img
            alt="Raj Kamal Singh"
...
<div className="flex flex-wrap">
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/Juneezee" className="block">
         <img
            alt="Raj Kamal Singh"
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Eng Zer Jun</div>
         <small className="text-sm text-signoz_vanilla-400">
         </small>
      </div>
      </div>
    ...
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/CKanishka" className="block">
         <img
            alt="Yunus M"
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Kanishka Chowdhury</div>
         <small className="text-sm text-signoz_vanilla-400">
         </small>
      </div>
      </div>
...
<div className="flex flex-wrap">
    ...
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/bwalding" className="block">
         <img
            alt="Yunus M"
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Ben Walding</div>
         <small className="text-sm text-signoz_vanilla-400">
         </small>
      </div>
      </div>
...
<div className="flex flex-wrap">
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/mknapcok" className="block">
         <img
            alt="Raj Kamal Singh"
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Michal Knapcok</div>
         <small className="text-sm text-signoz_vanilla-400">
         </small>
      </div>
      </div>
