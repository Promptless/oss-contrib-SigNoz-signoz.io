...
<figure data-zoomable>
    <OptimizedImg src="/img/blog/2022/06/jaeger_ui.webp" alt="Jaeger UI for showing traces"/>
...
<figure data-zoomable>
    <OptimizedImg src="/img/blog/common/signoz_charts_application_metrics.webp" alt="SigNoz dashboard showing popular RED metrics"/>
    <figcaption><i>SigNoz UI showing application overview metrics like RPS, 50th/90th/99th Percentile latencies, and Error Rate</i></figcaption>
</figure>

{/* <!-- <figure data-zoomable align='center'>
    <OptimizedImg className="box-shadowed-image"
    alt="SigNoz UI"
...
<figure data-zoomable>
    <OptimizedImg src="/img/blog/common/signoz_flamegraphs.webp" alt="SigNoz flamegraphs"/>
...
<figure data-zoomable>
    <OptimizedImg src="/img/blog/2022/06/jaeger_flamegraphs.webp" alt="Jaeger gantt charts"/>
...
<figure data-zoomable>
    <OptimizedImg src="/img/blog/common/signoz_service_maps_beta.webp" alt="SigNoz service maps"/>
    <figcaption><i>Interactive Service Maps shown on SigNoz dashboard</i></figcaption>
</figure>


<figure data-zoomable>
    <OptimizedImg src="/img/blog/2022/06/jaeger_dependency_graph.webp" alt="Jaeger's dependency graph"/>
...
<figure data-zoomable>
    <OptimizedImg src="/img/blog/common/trace_filter_apply_tags.webp" alt="You can filter traces with tags in SigNoz traces dashboard"/>
...
<figure data-zoomable>
    <OptimizedImg src="/img/blog/common/trace_filter_apply_aggregates.webp" alt="See aggregated metrics of filtered traces"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg src="/img/blog/2022/05/exceptions_monitoring.webp" alt="Exceptions monitoring tab on SigNoz dashboard"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg src="/img/blog/2022/05/signoz_stacktrace.webp" alt="Stacktrace on exceptions caught"/>
...
<figure data-zoomable>
    <OptimizedImg src="/img/blog/common/architecture-signoz-clickhouse.svg" alt="Technical architecture of SigNoz with ClickHouse setup"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg src="/img/blog/common/signoz_custom_dashboard-min.webp" alt="Custom dashboards on SigNoz"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg src="/img/blog/common/signoz_alerts.webp" alt="Set alerts on critical metrics"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg src="/img/blog/2022/05/org_management.webp" alt="Organization settings on SigNoz dashboard"/>
