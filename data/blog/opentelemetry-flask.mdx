...
<figure data-zoomable align='center'>
    <OptimizedImg src="/img/blog/2021/11/sample_flask_app.webp" alt="SigNoz dashboard showing application list"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg src="/img/blog/common/ingestion-key-details.webp" alt="Ingestion key details"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg src="/img/blog/2024/02/list_of_apps_flask.webp" alt="Flask app in the list of applications monitored by SigNoz"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg src="/img/blog/common/signoz_charts_application_metrics.webp" alt="SigNoz charts and metrics"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg src="/img/blog/common/trace_filter_apply_aggregates.webp" alt="List of traces on SigNoz dashboard"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg src="/img/blog/common/signoz_custom_dashboard-min.webp" alt="Custom metrics dashboard"/>
