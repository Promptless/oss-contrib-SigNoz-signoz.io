...
And, congratulations! You have instrumented your sample Flask app. You can check if your app is running or not by hitting the endpoint at <a href="http://localhost:5002/" target="_blank" rel="noopener noreferrer nofollow">http://localhost:5002/</a>.
