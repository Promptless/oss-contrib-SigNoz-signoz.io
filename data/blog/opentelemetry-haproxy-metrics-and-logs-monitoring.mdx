...
<Admonition>
The status URL configured is <a href="http://localhost:8000/haproxy?stats" target="_blank" rel="noopener noreferrer nofollow">localhost:8000/haproxy?stats</a> .
</Admonition>
...
You should start seeing stats on <a href="http://localhost:8000/haproxy?stats" target="_blank" rel="noopener noreferrer nofollow">http://localhost:8000/haproxy?stats</a> as shown below.
