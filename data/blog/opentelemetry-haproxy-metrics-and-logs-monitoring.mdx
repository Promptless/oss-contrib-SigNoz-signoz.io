...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2023/12/haproxy_stats.webp" alt="HAProxy stats on your local"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2023/12/haproxy_metrics.webp" alt="HAProxy metrics collected by OpenTelemetry collector"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2023/12/haproxy_panel.webp" alt="Creating a panel for Network in traffic - Bytes per second"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2023/12/haproxy_dashboard.webp" alt="Comprehensive HAProxy dashboard"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2023/12/haproxy_alerts.webp" alt=""/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2023/12/haproxy_logs.webp" alt=""/>
    <figcaption><i></i></figcaption>
</figure>
