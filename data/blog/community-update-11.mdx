...
**<a href="https://github.com/SigNoz/signoz/releases/tag/v0.7.4" target="_blank" rel="noopener noreferrer nofollow">v0.7.4</a>**<br></br>
**<a href="https://github.com/SigNoz/signoz/releases/tag/v0.7.5" target="_blank" rel="noopener noreferrer nofollow">v0.7.5</a>**
...
Relevant PR:<br></br>
<a href="https://github.com/SigNoz/signoz/pull/922" target="_blank" rel="noopener noreferrer nofollow">feat(query-service): Add cold storage support in getTTL API</a>
...
<a href="https://github.com/SigNoz/signoz/issues/940" target="_blank" rel="noopener noreferrer nofollow">Deploying SigNoz in large-scale production environments</a>
...
Feel free to comment on this <a href="https://github.com/SigNoz/signoz/issues/940" target="_blank" rel="noopener noreferrer nofollow">GitHub issue</a>.
...
<a href="https://github.com/SigNoz/signoz/pull/838" target="_blank" rel="noopener noreferrer nofollow">feat: query spans_table to fetch trace details</a>
