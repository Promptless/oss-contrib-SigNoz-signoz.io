...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2022/04/better_y_axis_legend.webp" alt=""/>
</figure>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2022/04/units_tooltip.webp" alt=""/>
</figure>
...
<div className="flex flex-wrap">
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      ...
      <a
         href="https://github.com/mindhash" className="block">
         <img
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Amol Umbark</div>
