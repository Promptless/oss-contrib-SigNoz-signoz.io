...
<div className="flex flex-wrap">
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      ...
      <a
         href="https://github.com/pts95" className="block">
         <img
            alt="Aditya Kumar"
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Aditya Kumar Praharaj</div>
    ...
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/zedongh" className="block">
         <img
            alt="Zedongh"
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Zedongh</div>
         <small className="text-sm text-signoz_vanilla-400">
         </small>
      </div>
      </div>
...
<div className="flex flex-wrap">
    ...
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/sudhanshud" className="block">
         <img
            alt="Sudhanshu"
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Sudhanshu</div>
         <small className="text-sm text-signoz_vanilla-400">
         </small>
      </div>
      </div>
...
<div className="flex flex-wrap">
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/EthanGeekFan" className="block">
         <img
            alt="Yifan Yang"
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Yifan Yang</div>
         <small className="text-sm text-signoz_vanilla-400">
         </small>
      </div>
      </div>
