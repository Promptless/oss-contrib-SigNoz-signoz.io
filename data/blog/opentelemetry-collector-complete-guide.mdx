...
<figure data-zoomable align='center'>
    <OptimizedImg src="/img/blog/2025/09/otel-deployment.webp" alt="OpenTelemetry Collector Deployment Patterns: Agent and Gateway"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg src="/img/blog/common/signoz_charts_application_metrics.webp" alt="SigNoz dashboard showing overview metrics like RPS"/>
