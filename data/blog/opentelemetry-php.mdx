...
<a href="https://github.com/SigNoz/sample-php-app" target="_blank" rel="noopener noreferrer nofollow">Sample PHP App</a>
...
Now open SigNoz UI at: <a href="http://localhost:3301/application" target="_blank" rel="noopener noreferrer nofollow">http://localhost:3301</a>, and go to the `Traces` tab, and select the span from service `signoz-php-app`.
