...
The native and recommended format for OpenTelemetry traces is <a href="https://opentelemetry.io/docs/specs/otel/protocol/" target="_blank" rel="noopener noreferrer nofollow">OTLP</a> (The OpenTelemetry Protocol).
...
### Attributes
  ...
  OpenTelemetry provides <a href="https://opentelemetry.io/docs/concepts/semantic-conventions/" target="_blank" rel="noopener noreferrer nofollow">Semantic Conventions</a>, which are standardized names for attributes (e.g., http.method, db.statement). Using
