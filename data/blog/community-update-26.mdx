...
<div className="flex flex-wrap">
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      ...
      <a
         href="https://github.com/sachinmk27" className="block">
         <img
            alt="Germa Vinsmoke"
         ...
         <div className="flex flex-col gap-1">
            <div className="font-bold">Sachin M K</div>
    ...
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/Rajat-Dabade" className="block">
         <img
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Rajat Dabade</div>
         <small className="text-sm text-signoz_vanilla-400">
         </small>
      </div>
      </div>
