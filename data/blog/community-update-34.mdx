...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/03/signal-34-cover.webp" alt="SigNal 34 cover image"/>
</figure>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/03/signal-34-aggregations.webp" alt="Spatial and temporal aggregations in metrics query builder of SigNoz"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/03/signal-34-functions.webp" alt="Metrics query builder functions to help extend data analysis capabilities on metrics"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/03/signal-34-histogram.webp" alt="Exponential Histograms provide better accuracy than fixed buckets histograms"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/03/signal-34-access-token-1.webp" alt=""/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/03/signal-34-access-token-2.webp" alt=""/>
    <figcaption><i></i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" width="70%" src="/img/blog/2024/03/signal-34-access-token-3.webp" alt=""/>
    <figcaption><i></i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/03/signal-34-postman.webp" alt=""/>
    <figcaption><i></i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/03/signal-34-paris.webp" alt=""/>
    <figcaption><i></i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/03/signal-34-reddit.webp" alt=""/>
    <figcaption><i></i></figcaption>
</figure>
...
<div className="flex flex-wrap">
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      ...
      <a
         href="https://github.com/features-not-bugs" className="block">
         <img
            alt="Hayden"
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Hayden</div>
    ...
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/lirantal" className="block">
         <img
            alt="Liran Tal"
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Liran Tal</div>
         <small className="text-sm text-signoz_vanilla-400">
         </small>
      </div>
      </div>
...
<div className="flex flex-wrap">
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/borrown" className="block">
         <img
            alt="Alexander"
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Alexander</div>
         <small className="text-sm text-signoz_vanilla-400">
         </small>
      </div>
      </div>
    ...
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/DPS0340" className="block">
         <img
            alt="Jiho Lee"
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Jiho Lee</div>
         <small className="text-sm text-signoz_vanilla-400">
         </small>
      </div>
      </div>
