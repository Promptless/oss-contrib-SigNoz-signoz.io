...
**License:** MIT (except for the enterprise folder). Details of the license are available in the <a href="https://github.com/SigNoz/signoz/blob/main/LICENSE" target="_blank" rel="noopener noreferrer nofollow">SigNoz GitHub repository</a>.
