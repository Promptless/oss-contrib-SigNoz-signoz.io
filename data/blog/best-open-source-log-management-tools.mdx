...
SigNoz can be a great open source logging tool 
...
**License:** MIT (except for the enterprise folder). You can check details of the license [here](https://github.com/SigNoz/signoz/blob/main/LICENSE).
