...
In our <a href="https://github.com/SigNoz/signoz" target="_blank" rel="noopener noreferrer nofollow">latest release</a> `v0.3.1` , we launched support for ClickHouse as storage backend for SigNoz. ClickHouse is a column-oriented database management system (DBMS) for online analytical processing of queries (OLAP). Now when you install SigNoz, you will have the option to choose between ClickHouse or Kafka + Druid as a database system.
...
As an open-source software, we build what our community wants. We listened to <a href="https://github.com/SigNoz/signoz/issues/22" target="_blank" rel="noopener noreferrer nofollow">demands</a> from our community for supporting ClickHouse as a storage backend.
