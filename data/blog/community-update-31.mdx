...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2023/12/signal31_improved_charts.webp" alt="Users can expect improved chart performance"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2023/12/signal31_threshold.webp" alt="Adding threshold for different types of views in Dashboard"/>
    <figcaption><i>Adding threshold for different types of views in Dashboard</i></figcaption>
</figure>


<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2023/12/signal31_threshold_time_series.webp" alt="Adding Threshold in the Time-Series chart"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2023/12/signal31_full_screen.webp" alt="You can now view your Dashboards in “Full Screen View”"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2023/12/signal31_alerts.webp" alt="Create Alerts directly from Dashboards Tab"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2023/12/signal31_fill_spans.webp" alt="Graphs with Fill Span Gaps Disabled and Enabled"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2023/12/7-million-docker-downloads.webp" alt="7 million docker downloads"/>
...
<div className="flex flex-wrap">
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      ...
      <a
         href="https://github.com/Calm-Rock" className="block">
         <img
            alt="CheetoDa"
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">CheetoDa</div>
    ...
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/alrs" className="block">
         <img
            alt="Lars Lehtonen"
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Lars Lehtonen</div>
         <small className="text-sm text-signoz_vanilla-400">
         </small>
      </div>
      </div>
...
<div className="flex flex-wrap">
    ...
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/joemiltonm" className="block">
         <img
            alt="Joe Milton"
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Joe Milton</div>
         <small className="text-sm text-signoz_vanilla-400">
         </small>
      </div>
      </div>
...
<div className="flex flex-wrap">
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/srikanth-iyengar" className="block">
         <img
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Srikanth Iyengar</div>
         <small className="text-sm text-signoz_vanilla-400">
         </small>
      </div>
      </div>
    ...
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/veyselsahin" className="block">
         <img
            alt="Veysel Şahin"
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Veysel Şahin</div>
         <small className="text-sm text-signoz_vanilla-400">
         </small>
      </div>
      </div>
...
<div className="flex flex-wrap">
    ...
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/aleksasiriski" className="block">
         <img
            alt="Aleksa Siriški"
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Aleksa Siriški</div>
         <small className="text-sm text-signoz_vanilla-400">
         </small>
      </div>
      </div>
