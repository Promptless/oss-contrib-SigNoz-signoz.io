...
<figure data-zoomable align='center'>
    <OptimizedImg className="box-shadowed-image" src="/img/blog/2023/12/signal31_improved_charts.webp" alt="Users can expect improved chart performance"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg className="box-shadowed-image" src="/img/blog/2023/12/signal31_threshold.webp" alt="Adding threshold for different types of views in Dashboard"/>
    <figcaption><i>Adding threshold for different types of views in Dashboard</i></figcaption>
</figure>


<figure data-zoomable align='center'>
    <OptimizedImg className="box-shadowed-image" src="/img/blog/2023/12/signal31_threshold_time_series.webp" alt="Adding Threshold in the Time-Series chart"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg className="box-shadowed-image" src="/img/blog/2023/12/signal31_full_screen.webp" alt="You can now view your Dashboards in “Full Screen View”"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg className="box-shadowed-image" src="/img/blog/2023/12/signal31_alerts.webp" alt="Create Alerts directly from Dashboards Tab"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg className="box-shadowed-image" src="/img/blog/2023/12/signal31_fill_spans.webp" alt="Graphs with Fill Span Gaps Disabled and Enabled"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg className="box-shadowed-image" src="/img/blog/2023/12/7-million-docker-downloads.webp" alt="7 million docker downloads"/>
