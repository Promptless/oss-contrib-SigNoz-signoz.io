...
For those who are new to the space, auto-instrumentation refers to collecting telemetry [traces, metrics, logs] from your application without requiring you to make changes to the application code. You can read more about it from the <a href="https://opentelemetry.io/docs/concepts/instrumentation/zero-code/" target="_blank" rel="noopener noreferrer nofollow">official docs</a> here.
