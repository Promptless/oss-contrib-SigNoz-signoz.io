...
3. Assuming each time series requires ~3-4 KB of memory (<a href="https://www.robustperception.io/why-does-prometheus-use-so-much-ram/" target="_blank" rel="noopener noreferrer nofollow">source</a>)
...
Note: InfluxDB introduced <a href="https://docs.influxdata.com/influxdb/v1/concepts/time-series-index/" target="_blank" rel="noopener noreferrer nofollow">TSI</a> specifically to move the time-series index to disk (memory-mapped) and reduce RAM as the limiting factor, though high series cardinality can still hurt performance and memory.
