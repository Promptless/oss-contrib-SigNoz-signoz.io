...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2023/11/memory.webp" alt="Memory usage"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2023/11/key-operations.webp" alt="Key Operations List"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2023/11/trace-detail.webp" alt="Trace Detail graph"/>
