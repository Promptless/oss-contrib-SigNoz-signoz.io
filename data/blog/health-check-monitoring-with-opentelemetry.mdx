...
<figure data-zoomable align='center'>
<img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2023/12/create_new_dashboard.webp" alt="Create a new dashboard and click on the time-series panel type"/>
...
<figure data-zoomable align='center'>
<img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2023/12/receiver_metrics_signoz.webp" alt="HTTP Receiver Metrics monitored by SigNoz"/>
...
<figure data-zoomable align='center'>
<img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2023/12/https_check_status.webp" alt=""/>
...
<figure data-zoomable align='center'>
<img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2023/12/monitoring_chart_signoz.webp" alt="Chart for monitoring HTTP endpoints in SigNoz"/>
...
<figure data-zoomable align='center'>
<img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2023/12/alert_endpoint_down.webp" alt="Create alerts to be notified in case an endpoint is down"/>
