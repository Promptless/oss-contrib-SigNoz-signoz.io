...
For our demo, we’ll deploy the <a href="https://opentelemetry.io/docs/demo/architecture/" target="_blank" rel="noopener noreferrer nofollow">OpenTelemetry Astronomy Shop demo application</a> in a minikube cluster, a microservices app instrumented with OpenTelemetry [it generates traces, metrics and logs]. The OTel project provides a <a href="https://github.com/open-telemetry/opentelemetry-helm-charts/tree/main/charts/opentelemetry-demo" target="_blank" rel="noopener noreferrer nofollow">convenient Helm chart for this demo</a>.
...
Ensure you have <a href="https://minikube.sigs.k8s.io/docs/start/?arch=%2Fmacos%2Farm64%2Fstable%2Fbinary+download" target="_blank" rel="noopener noreferrer nofollow">Minikube</a> running [a single-node Kubernetes cluster] and have `kubectl` and `helm` installed. 
...
The <a href="https://github.com/open-telemetry/opentelemetry-helm-charts/tree/main/charts/opentelemetry-collector" target="_blank" rel="noopener noreferrer nofollow">official Helm chart</a> makes it easy to enable these pieces via presets. Let's prepare a values file for the Helm chart [call it otel-collector-daemonset.yaml **].**
