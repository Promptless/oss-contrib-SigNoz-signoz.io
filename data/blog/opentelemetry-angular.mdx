...
If you already have a sample Angular application, you can follow the steps below to instrument it for observability. Alternatively, you can use this <a href="https://github.com/SigNoz/angular-otel-native" target="_blank" rel="noopener noreferrer nofollow">sample Angular app</a> provided. This app includes boilerplate code with instrumentation already set up.
