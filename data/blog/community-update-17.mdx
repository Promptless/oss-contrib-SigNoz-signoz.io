...
<div className="flex flex-wrap">
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      ...
      <a
         href="https://github.com/vg18gupta" className="block">
         <img
            alt="Vishal Gupta"
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Vishal Gupta</div>
    ...
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/bjohnso5" className="block">
         <img
            alt="Bryan Johnson"
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Bryan Johnson</div>
         <small className="text-sm text-signoz_vanilla-400">
         </small>
      </div>
      </div>
...
<div className="flex flex-wrap">
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/Trugamr" className="block">
         <img
            alt="Shivam Dua"
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Shivam Dua</div>
         <small className="text-sm text-signoz_vanilla-400">
         </small>
      </div>
      </div>
    ...
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/publikphigor" className="block">
         <img
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Koladele Olaitan</div>
         <small className="text-sm text-signoz_vanilla-400">
         </small>
      </div>
      </div>
