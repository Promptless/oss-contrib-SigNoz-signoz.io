...
To prepare the OTel baggage demo for use, you must first clone the <a href="https://github.com/SigNoz/examples" target="_blank" rel="noopener noreferrer nofollow">SigNoz examples GitHub repo</a>, that hosts all examples we maintain for various blogs.
...
You can try it out with [**SigNoz Cloud**](https://signoz.io/teams/) or self-host the <a href="https://github.com/SigNoz/signoz" target="_blank" rel="noopener noreferrer nofollow">**Community Edition**</a> for free.