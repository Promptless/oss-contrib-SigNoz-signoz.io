...
<figure data-zoomable align='center'>
    <OptimizedImg className="box-shadowed-image" src="/img/blog/2024/02/signal-33-theme_update.webp" alt="SigNoz now comes with an updated theme with new color scheme, fonts, and a sleek new sidebar"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg className="box-shadowed-image" src="/img/blog/2024/02/signal-33-add-log-attributes.webp" alt="Add log attributes in the Raw view of logs"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg className="box-shadowed-image" src="/img/blog/2024/02/signal-33-date-time-picker.gif" alt=""/>
...
<figure data-zoomable align='center'>
    <OptimizedImg className="box-shadowed-image" src="/img/blog/2024/02/signal-33-16k-github-stars.webp" alt=""/>
    <figcaption><i></i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <OptimizedImg className="box-shadowed-image" src="/img/blog/2024/02/signal-33-HN-front-page.webp" alt=""/>
    <figcaption><i></i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <OptimizedImg className="box-shadowed-image" src="/img/blog/2024/02/signal-33-tools-to-watch-in-2024.webp" alt="SigNoz is one of the four observability tools to watch out for in 2024"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg className="box-shadowed-image" src="/img/blog/2024/02/signal-33-thousandeyes.webp" alt=""/>
    <figcaption><i></i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <OptimizedImg className="box-shadowed-image" src="/img/blog/2024/02/signal-33-user-shoutout.webp" alt="SigNoz - the new hotness for open-source observability"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg className="box-shadowed-image" src="/img/blog/2024/02/signal-33-chinmay-says.webp" alt="SigNoz - the default choice for OpenTelemetry backend"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg className="box-shadowed-image" src="/img/blog/2024/02/signal-33-samsung-says.webp" alt="SigNoz is being used by engineering teams of all sizes - Here devs at Samsung Research using SigNoz for observability"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg className="box-shadowed-image" src="/img/blog/2024/02/signal-33-community-tutorials.webp" alt="Tutorial on OpenTelemetry and SigNoz setup in a Nodejs application deployed on Kubernetes"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg className="box-shadowed-image" src="/img/blog/2024/02/signal-33-egor-shoutout.webp" alt="Tutorial on structured logging in a Nestjs application and sending logs to SigNoz"/>
