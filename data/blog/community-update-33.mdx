...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/02/signal-33-theme_update.webp" alt="SigNoz now comes with an updated theme with new color scheme, fonts, and a sleek new sidebar"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/02/signal-33-add-log-attributes.webp" alt="Add log attributes in the Raw view of logs"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/02/signal-33-date-time-picker.gif" alt=""/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/02/signal-33-16k-github-stars.webp" alt=""/>
    <figcaption><i></i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/02/signal-33-HN-front-page.webp" alt=""/>
    <figcaption><i></i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/02/signal-33-tools-to-watch-in-2024.webp" alt="SigNoz is one of the four observability tools to watch out for in 2024"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/02/signal-33-thousandeyes.webp" alt=""/>
    <figcaption><i></i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/02/signal-33-user-shoutout.webp" alt="SigNoz - the new hotness for open-source observability"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/02/signal-33-chinmay-says.webp" alt="SigNoz - the default choice for OpenTelemetry backend"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/02/signal-33-samsung-says.webp" alt="SigNoz is being used by engineering teams of all sizes - Here devs at Samsung Research using SigNoz for observability"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/02/signal-33-community-tutorials.webp" alt="Tutorial on OpenTelemetry and SigNoz setup in a Nodejs application deployed on Kubernetes"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/02/signal-33-egor-shoutout.webp" alt="Tutorial on structured logging in a Nestjs application and sending logs to SigNoz"/>
...
<div className="flex flex-wrap">
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      ...
      <a
         href="https://github.com/s4nju" className="block">
         <img
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Sanjib Kumar Sah</div>
    ...
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/keshavg2" className="block">
         <img
            alt="Keshav Gupta"
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Keshav Gupta</div>
         <small className="text-sm text-signoz_vanilla-400">
         </small>
      </div>
      </div>
...
<div className="flex flex-wrap">
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/vikrantgupta25" className="block">
         <img
            alt="Vikrant Gupta"
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Vikrant Gupta</div>
         <small className="text-sm text-signoz_vanilla-400">
         </small>
      </div>
      </div>
    ...
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/zimbatm" className="block">
         <img
            alt="Jonas Chevalier"
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Jonas Chevalier</div>
         <small className="text-sm text-signoz_vanilla-400">
         </small>
      </div>
      </div>
...
<div className="flex flex-wrap">
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/fabiob" className="block">
         <img
            alt="Fábio D. Batista"
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Fábio D. Batista</div>
         <small className="text-sm text-signoz_vanilla-400">
         </small>
      </div>
      </div>
    ...
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/VishnuTeja27" className="block">
         <img
            alt="Vishnu Teja"
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Vishnu Teja</div>
         <small className="text-sm text-signoz_vanilla-400">
         </small>
      </div>
      </div>
...
<div className="flex flex-wrap">
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/luna215" className="block">
         <img
            alt="Paul Luna"
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Paul Luna</div>
         <small className="text-sm text-signoz_vanilla-400">
         </small>
      </div>
      </div>
    ...
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/hwoodiwiss" className="block">
         <img
            alt="Hugo Woodiwiss"
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Hugo Woodiwiss</div>
         <small className="text-sm text-signoz_vanilla-400">
         </small>
      </div>
      </div>
