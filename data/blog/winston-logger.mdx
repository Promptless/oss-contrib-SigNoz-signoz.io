...
Logging levels in `winston` follow the severity ordering specified by <a href="https://tools.ietf.org/html/rfc5424" target="_blank" rel="noopener noreferrer nofollow">RFC5424</a>: severity of all levels is assumed to be numerically **ascending** from most important to least important*.*

Each `level` is given a specific integer priority. The higher the priority, the more important the message is considered, and the lower the corresponding integer priority. For example, as specified in <a href="https://tools.ietf.org/html/rfc5424" target="_blank" rel="noopener noreferrer nofollow">RFC5424</a> the `syslog` levels are prioritized from 0 to 7 (highest to lowest).
...
Formats in `winston` can be accessed from `winston.format`. They are implemented in <a href="https://github.com/winstonjs/logform" target="_blank" rel="noopener noreferrer nofollow">logform</a>, a separate module from `winston`. This allows flexibility when writing your transports in case you wish to include a default format with your transport.
...
- <a href="https://nodejs.org/en/blog/release/v14.17.3/" target="_blank" rel="noopener noreferrer nofollow">Nodejs  v14</a>
- <a href="https://expressjs.com/" target="_blank" rel="noopener noreferrer nofollow">Express</a>
- <a href="https://docs.npmjs.com/cli/v6/commands/npm-install" target="_blank" rel="noopener noreferrer nofollow">NPM v6</a>
- <a href="https://www.docker.com/products/docker-desktop/" target="_blank" rel="noopener noreferrer nofollow">Docker</a>
...
SigNoz uses a columnar database - ClickHouse, for storing logs efficiently. Big companies like <a href="https://www.uber.com/blog/logging/" target="_blank" rel="noopener noreferrer nofollow">Uber</a> and <a href="https://blog.cloudflare.com/log-analytics-using-clickhouse/" target="_blank" rel="noopener noreferrer nofollow">Cloudflare</a> have shifted from Elasticsearch to ClickHouse for storing their log data.
