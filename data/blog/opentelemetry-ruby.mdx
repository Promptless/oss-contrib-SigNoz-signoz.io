...
After following above steps, you can now monitor your Rails app with SigNoz. You can use this <a href="https://github.com/SigNoz/sample-rails-app" target="_blank" rel="noopener noreferrer nofollow">sample Ruby on Rails app</a> that was instrumented using above steps to see how the collected data is visualized with SigNoz dashboard.
...
Now the app should be running at <a href="http://localhost:3000/" target="_blank" rel="noopener noreferrer nofollow">http://localhost:3000/</a>
...
Now navigate to <a href="http://localhost:3301/application" target="_blank" rel="noopener noreferrer nofollow">http://localhost:3301/application</a> (needs signup) to analyse the telemetry data of Rails app.
