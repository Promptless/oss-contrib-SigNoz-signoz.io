...
Last month, we had two major releases: <a href="https://github.com/SigNoz/signoz/releases/tag/v0.3.1" target="_blank" rel="noopener noreferrer nofollow">v0.3.1</a> and <a href="https://github.com/SigNoz/signoz/releases/tag/v0.3.2" target="_blank" rel="noopener noreferrer nofollow">v0.3.2</a>.
...
If you have any views on the above, would love it if you can add a comment to the <a href="https://github.com/SigNoz/signoz/issues/193" target="_blank" rel="noopener noreferrer nofollow">issue</a>.
...
We got **featured in **<a href="https://golangweekly.com/issues/367" target="_blank" rel="noopener noreferrer nofollow">**Golang weekly**</a> for our blog on instrumenting Golang app with SigNoz. We also got featured in **DevOpsLinks by Faun.dev**, one of Medium's largest DevOps publications. With these features, we are grateful to reach new developers across the globe.
...
Shout out to Raj and <a href="https://github.com/jyash97" target="_blank" rel="noopener noreferrer nofollow">Yash</a> our new contributors who have been awesome in making significant contributions to SigNoz this month. 🙌

---

Thank you for taking out the time to read our second issue :) If you have any feedback or want any changes with the format, create an issue <a href="https://github.com/SigNoz/signoz/issues" target="_blank" rel="noopener noreferrer nofollow">here</a>.
