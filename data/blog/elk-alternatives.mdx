...
<figure data-zoomable align='center'>
    <OptimizedImg src="/img/blog/common/signoz_logs.webp" alt="Log management in SigNoz"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg src="/img/blog/2022/10/signoz_live_logs.webp" alt="Live Tail Logging in SigNoz"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg src="/img/blog/2022/10/signoz_log_query_builder.webp" alt="Advanced Log Query Builder in SigNoz"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg src="/img/blog/2022/10/logzio_log_management.webp" alt="logzio log management dashboard"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg src="/img/blog/2022/10/graylog_logs_management.webp" alt="Graylog log management dashboard"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg src="/img/blog/2022/10/logtail_log_management.webp" alt="LogTail Log Management Dashboard"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg src="/img/blog/2022/10/sumo_logic_log_management.webp" alt="Docker dashboards from Docker Logs in Sumo Logic"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg src="/img/blog/2022/10/loki_logs_management.webp" alt="Loki Logs dashboards in Grafana"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg src="/img/blog/2022/10/splunk_log_observer.webp" alt="Splunk Log Observer (Source: Splunk website)"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg src="/img/blog/2022/10/loggly_log_management.webp" alt="Loggly Log Management Dashboards"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg src="/img/blog/2022/10/sematext_logs_management.webp" alt="Sematext Log Management Dashboards"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg src="/img/blog/2022/10/datadog_log_management.webp" alt="Log Explorer in DataDog"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg src="/img/blog/2022/10/newrelic_log_management.webp" alt="Log Management dashboard in New Relic"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg src="/img/blog/2022/10/dynatrace_log_management.webp" alt="Log management in Dynatrace"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg src="/img/blog/2022/10/mezmo_log_management.webp" alt="Mezmo dashboard with insights from logs"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg src="/img/blog/2022/10/papertrail_log_management.webp" alt="Papertrail log management dashboard (Source: Papertrail website)"/>
