...
<figure data-zoomable align='center'>
<img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/01/opentelemetry-vs-promtheus-metrics.webp" alt="OpenTelemetry vs Prometheus - Metrics representation in Prometheus"/>
