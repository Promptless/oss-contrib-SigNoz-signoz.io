...
<figure data-zoomable align='center'>
<OptimizedImg className="box-shadowed-image" src="/img/blog/2024/01/opentelemetry-vs-promtheus-metrics.webp" alt="OpenTelemetry vs Prometheus - Metrics representation in Prometheus"/>
