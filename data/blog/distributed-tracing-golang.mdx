...
<figure data-zoomable align='center'>
    <OptimizedImg src="/img/blog/common/signoz_dashboard_homepage.webp" alt="SigNoz dashboard"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg src="/img/blog/2022/05/distributed_tracing_app_otel_signoz.webp" alt="How an application with microservices fits with OpenTelemetry and SigNoz"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg src="/img/blog/2022/05/distributed_tracing_golang_sql.webp" alt="Screenshot of terminal showing MySQL database working"/>
</figure>
...
1. Create a user:<br></br>
   ...
   <figure data-zoomable align='center'>
    <OptimizedImg src="/img/blog/2022/05/dt_golang_create_user.webp" alt="Create user using UI"/>
    </figure>
...
2. Transfer the fund:<br></br>
   ...
   <figure data-zoomable align='center'>
    <OptimizedImg src="/img/blog/2022/05/dt_golang_transfer_fund.webp" alt="Transfer Funds using UI"/>
    </figure>
...
3. Place an order:<br></br>
   Place an order by selecting a product from the dropdown.
    ...
    <figure data-zoomable align='center'>
    <OptimizedImg src="/img/blog/2022/05/dt_golang_place_order.webp" alt="Place orders using UI"/>
    </figure>
...
<figure data-zoomable align='center'>
    <OptimizedImg src="/img/blog/2022/05/dt_golang_application_metrics.webp" alt="SigNoz dashboard showing application metrics"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg src="/img/blog/2022/05/dt_golang_external_calls.webp" alt="SigNoz dashboard showing external calls"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg src="/img/blog/2022/05/dt_golang_gantt.webp" alt="SigNoz dashboard showing a user request broken down by Flamegraphs and Gantt charts"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg src="/img/blog/2022/05/dt_golang_gantt_2.webp" alt="Gantt charts showing details on time utilised in various SQL DB calls"/>
