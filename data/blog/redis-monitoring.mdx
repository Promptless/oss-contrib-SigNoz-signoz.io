...
To achieve this correlation, instrument your application code with <a href="https://opentelemetry.io/ecosystem/registry/?s=redis&amp;flag=all" target="_blank" rel="noopener noreferrer nofollow">Redis telemetry libraries</a>. These [OpenTelemetry](https://signoz.io/opentelemetry/) libraries will capture the queries generated by the Redis engine. This gives you deep context into your application's interaction with Redis on a per-request basis- something metrics alone cannot provide.
