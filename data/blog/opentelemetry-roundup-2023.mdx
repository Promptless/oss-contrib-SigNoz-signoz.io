...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/01/opentelemetry-growth.png" alt="OpenTelemetry is the 2nd most active CNCF project after Kubernetes"/>
...
1. **How to setup OpenTelemetry at scale**
    ...
    <figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/01/sidecar-pattern.png" alt="Sidecar Pattern for collecting telemetry data in Kubernetes"/>
...
1. **Leveraging OpenTelemetry semantic conventions**
   ...
   - Linking traces and logs is more easily possible by inserting and using `traceid` fields in logs to show related logs to traces. This helps in correlating logs and traces easily and debugging issues faster.
    ...
    <figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/01/logs-data-model.png" alt="OpenTelemetry Logs Data Model"/>
...
8. **Using OTEL OpAMP framework for logs pipeline**
    ...
    <figure data-zoomable align='center'>
        <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/01/opamp-signoz.png" alt="Logs Pipeline architecture using OpAMP"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/01/otel-arrow.png" alt="Traffic reduction with OTel Arrow"/>
