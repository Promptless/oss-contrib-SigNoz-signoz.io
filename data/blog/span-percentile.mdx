...
We're curious which filters you find yourself adding most often. That'll help us decide what to include in the default scope. Drop us a note in <a href="https://github.com/SigNoz/signoz/discussions" target="_blank" rel="noopener noreferrer nofollow">GitHub Discussions</a> or the [SigNoz Community Slack](https://signoz.io/slack/).