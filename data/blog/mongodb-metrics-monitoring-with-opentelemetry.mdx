...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2023/11/mongodb_metrics.webp" alt="MongoDB metrics collected using Opentelemetry Collector"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2023/11/mongodb_create_dashboard.webp" alt="Creating a dashboard panel for average queries executed"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2023/11/mongodb_dashboard.webp" alt="Complete MongoDB monitoring Dashboard"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2023/11/mongodb_alerts.webp" alt="Creating alerts from Dashboard panels"/>
