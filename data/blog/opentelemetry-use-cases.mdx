...
<figure data-zoomable align='center'>
    <OptimizedImg src="/img/blog/common/signoz_flamegraphs.webp" alt="This is how a trace looks like in an OpenTelemetry-native backend like SigNoz"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg src="/img/blog/common/signoz_charts_application_metrics.webp" alt="APM charts showing p90, p99 latency, request rate, apdex, etc. in an OpenTelemetry-native backend, SigNoz"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg src="/img/blog/common/signoz-infra-metrics.webp" alt="Hostmetrics Dashboard in SigNoz where metrics is collected by OTel Collector"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg src="/img/blog/common/signoz_logs_raw_color.webp" alt="Logs Management in SigNoz that is powered by OpenTelemetry"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg src="/img/blog/common/signoz_exceptions_monitoring.webp" alt="Exceptions monitoring in SigNoz"/>
