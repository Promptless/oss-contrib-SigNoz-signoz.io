...
Here’s an <a href="https://valyala.medium.com/prometheus-storage-technical-terms-for-humans-4ab4de6c3d48" target="_blank" rel="noopener noreferrer nofollow">article</a> with a list of terms around [Prometheus storage](https://signoz.io/guides/how-to-increase-prometheus-storage-retention/).
...
You can check out <a href="https://github.com/signoz/signoz" target="_blank" rel="noopener noreferrer nofollow">SigNoz GitHub</a> repo:
