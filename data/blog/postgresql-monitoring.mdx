...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/01/postgresql-monitoring-table.webp" alt="Monitoring table and index sizes for PostgreSQL"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/01/postgresql-monitoring-index.webp" alt="Check all indexes in your PostgreSQL database"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/01/postgresql-monitoring-pooling.webp" alt="Connection Pooling in PostgreSQL"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/01/postgresql-monitoring-stats.webp" alt="Show Stats output for PgBouncer"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/01/postgresql-monitoring-deadlock.webp" alt="Locks and Deadlocks in PostgreSQL"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/01/postgresql-monitoring-sample-output.webp" alt="Sample output for query on pg_locks and pg_stat_activity"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/01/postgresql-monitoring-signoz.webp" alt="Postgresql monitoring tool - SigNoz"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/01/postgresql-monitoring-pgAnalyze.webp" alt="Postgresql monitoring tool - pgAnalyze"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/01/postgresql-monitoring-pgDash.webp" alt="Postgresql monitoring tool - pgDash"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/01/postgresql-monitoring-new-relic.webp" alt="Postgresql monitoring tool - New Relic"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/01/postgresql-monitoring-datadog.webp" alt="Postgresql monitoring tool - Datadog"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/01/postgresql-monitoring-grafana.webp" alt="Postgresql monitoring tool - Grafana"/>
