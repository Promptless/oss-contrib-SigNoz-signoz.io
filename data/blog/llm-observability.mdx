...
- Langchain App: If you just want to play around to understand SigNoz's capabilities, here’s a <a href="https://github.com/SigNoz/langchain-sample-app" target="_blank" rel="noopener noreferrer nofollow">sample Langchain application</a>.
...
<a href="https://github.com/SigNoz/dashboards/blob/main/llm-observability/sample-chatpdf-performance-metrics.json" target="_blank" rel="noopener noreferrer nofollow">JSON for Langchain App Performance Dashboard</a>

<a href="https://github.com/SigNoz/dashboards/blob/main/llm-observability/sample-chatpdf-cost-dashboard.json" target="_blank" rel="noopener noreferrer nofollow">JSON for Langchain App Cost Dashboard</a>
