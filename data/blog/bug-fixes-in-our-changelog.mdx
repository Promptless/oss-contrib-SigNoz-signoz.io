...
Over time, small frictions add up simply because more people are using more parts of the product in more ways. Ankit, and by extension, the team realized that <a href="https://jamesclear.com/book-summaries/what-got-you-here-wont-get-you-there" target="_blank" rel="noopener noreferrer nofollow">**what got us here won’t get us there**</a>.
...
The same instinct showed up later in trace analytics. He talked about spending time with the <a href="https://research.google/pubs/dapper-a-large-scale-distributed-systems-tracing-infrastructure/" target="_blank" rel="noopener noreferrer nofollow">Dapper paper</a> and studying distributed tracing in depth. That research made it clear that many real-world systems don’t fit neatly into simple request-response models. Async workflows, messaging systems, long-running background jobs, and websockets create traces that are large and hard to reason about.
