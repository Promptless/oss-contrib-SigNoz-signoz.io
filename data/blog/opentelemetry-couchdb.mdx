...
<figure data-zoomable align='center'>
    <OptimizedImg className="box-shadowed-image" src="/img/blog/2024/01/opentelemetry-couchdb-signoz-metrics-panel.webp" alt="Signoz Panel CouchDB Metrics to add on Dashboard"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg className="box-shadowed-image" src="/img/blog/2024/01/opentelemetry-couchdb-dashboard.webp" alt="CouchDB Dashboard on Signoz"/>
