...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2023/12/aws_ecs_metrics.webp" alt="OpenTelemetry ECS monitoring with SigNoz"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2023/12/aws_ecs_logs.webp" alt="Logs of AWS ECS collected with OpenTelemetry"/>
