...
<figure data-zoomable align='center'>
    <OptimizedImg className="box-shadowed-image" src="/img/blog/2023/12/k8s_dashboard.webp" alt="SigNoz dashboard"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg className="box-shadowed-image" src="/img/blog/2023/12/k8s_dashboard_config.webp" alt="Configuring dashboard"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg className="box-shadowed-image" src="/img/blog/2023/12/k8s_dashboard_naming.webp" alt="Dashboard Naming"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg className="box-shadowed-image" src="/img/blog/2023/12/k8s_dashboard_visualization.webp" alt="Dashboard visualization options"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg className="box-shadowed-image" src="/img/blog/2023/12/k8s_metrics1.webp" alt="Collected Kubernetes cluster metrics for visualization"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg className="box-shadowed-image" src="/img/blog/2023/12/k8s_monitoring_dashboard.webp" alt="Monitoring dashboard for the Kubernetes cluster"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg className="box-shadowed-image" src="/img/blog/2023/12/k8s_alerts.webp" alt="Create alerts on important Kubernetes cluster"/>
