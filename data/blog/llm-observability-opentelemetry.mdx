...
* **Follow OTel GenAI working group** - There is active work happening in OTel <a href="https://opentelemetry.io/blog/2024/otel-generative-ai/" target="_blank" rel="noopener noreferrer nofollow">Gen AI working group</a>. Follow the work happening there and do share your use cases so that the standards which OpenTelemetry builds are able to cater to most common use cases.
