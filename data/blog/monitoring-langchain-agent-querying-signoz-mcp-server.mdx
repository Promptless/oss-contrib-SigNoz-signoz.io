...
Want to explore the LangChain SigNoz MCP Agent in action? Clone the <a href="https://github.com/SigNoz/signoz-mcp-demo" target="_blank" rel="noopener noreferrer nofollow">repo</a>, install dependencies, and follow the setup steps in the <a href="https://github.com/SigNoz/signoz-mcp-demo/blob/main/README.md" target="_blank" rel="noopener noreferrer nofollow">README</a> to connect the agent with your own SigNoz instance.
