...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/01/signal-32-hostmetrics.webp" alt="Hostmetrics Dashboard in SigNoz"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/01/signal-32-spantime-1.webp" alt="See details like duration and start time of a span upon hovering"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/01/signal-32-spantime-2.webp" alt="See details like duration and start time of a span while hovering over it"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/01/signal-32-new-log-processor.webp" alt="We have added Severity and Timestamp parsers to the list of logs processors"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/01/signal-32-improved-legend.webp" alt="Click on the legend of the graph to highlight it"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/01/signal-32-nested-var-chain.webp" alt="Arrange your variables, like deployment_environment, service_name, etc., in any sequence that makes sense"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/01/signal-32-user-shoutout-reddit.webp" alt=""/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/01/signal-32-devfest.webp" alt=""/>
    <figcaption><i></i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/01/signal-32-twitter-shoutout-1.webp" alt=""/>
    <figcaption><i></i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/01/signal-32-twitter-shoutout-2.webp" alt=""/>
    <figcaption><i></i></figcaption>
</figure>
...
<div className="flex flex-wrap">
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      ...
      <a
         href="https://github.com/avijeetpandey" className="block">
         <img
            alt="Avijeet Pandey"
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Avijeet Pandey</div>
    ...
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/grvv" className="block">
         <img
            alt="Gaurav Sharma"
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Gaurav Sharma</div>
         <small className="text-sm text-signoz_vanilla-400">
         </small>
      </div>
      </div>
...
<div className="flex flex-wrap">
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/testwill" className="block">
         <img
            alt="guangwu"
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">guangwu</div>
         <small className="text-sm text-signoz_vanilla-400">
         </small>
      </div>
      </div>
    ...
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/alexbowers" className="block">
         <img
            alt="Alex Bowers"
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Alex Bowers</div>
         <small className="text-sm text-signoz_vanilla-400">
         </small>
      </div>
      </div>
