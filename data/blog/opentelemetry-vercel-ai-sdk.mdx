...
Check out more detailed information about Vercel AI SDK’s telemetry options visit <a href="https://ai-sdk.dev/docs/ai-sdk-core/telemetry#telemetry" target="_blank" rel="noopener noreferrer nofollow">here</a>.
...
Your Vercel AI SDK commands should now automatically emit traces, spans, and events. You can find more details on the types of spans and events generated <a href="https://ai-sdk.dev/docs/ai-sdk-core/telemetry#collected-data" target="_blank" rel="noopener noreferrer nofollow">here</a>.
...
For a complete list of all captured attributes and functions, you can refer to the <a href="https://ai-sdk.dev/docs/ai-sdk-core/telemetry#collected-data" target="_blank" rel="noopener noreferrer nofollow">official Vercel AI SDK telemetry documentation</a>.
