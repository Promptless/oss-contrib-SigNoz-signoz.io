...
<figure data-zoomable align='center'>
    <OptimizedImg className="box-shadowed-image" src="/img/blog/2023/12/helm_deployed.webp" alt=""/>
...
<figure data-zoomable align='center'>
    <OptimizedImg className="box-shadowed-image" src="/img/blog/2023/12/otel_agent_logs.webp" alt="You will see an output like this"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg className="box-shadowed-image" src="/img/blog/2023/12/helm_configs.webp" alt="Generated configuration through helm charts"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg className="box-shadowed-image" src="/img/blog/2023/12/daemonset_congfigs.webp" alt=""/>
    <figcaption><i></i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <OptimizedImg className="box-shadowed-image" src="/img/blog/2023/12/view_access_token.webp" alt=""/>
    <figcaption><i></i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <OptimizedImg className="box-shadowed-image" src="/img/blog/2023/12/k8s_metrics.webp" alt="Plotting a metric into a panel in a dashboard"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg className="box-shadowed-image" src="/img/blog/2023/12/node_dashboard.webp" alt="Node Dashboard for EKS cluster"/>
    <figcaption><i>Node Dashboard for EKS cluster</i></figcaption>
</figure>


<figure data-zoomable align='center'>
    <OptimizedImg className="box-shadowed-image" src="/img/blog/2023/12/pod_dashboard.webp" alt="Pod Dashboard for EKS cluster"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg className="box-shadowed-image" src="/img/blog/2023/12/pod_dashboard_filtered.webp" alt="Pod Dashboard Filtered with default namespace and an otel-demo-frontend pod"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg className="box-shadowed-image" src="/img/blog/2023/12/create_alert_k8s.webp" alt="Creating an alert from dashboard"/>
