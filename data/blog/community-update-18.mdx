...
We launched support for logs in <a href="https://github.com/SigNoz/signoz/releases/tag/v0.11.0" target="_blank" rel="noopener noreferrer nofollow">v0.11.0</a>. We use OpenTelemetry for collecting and processing logs. Logs have the biggest legacy among the three telemetry signals(metrics, traces, and logs). Unlike traces and metrics, OpenTelemetry logs take a different approach. OpenTelemetry aims to support the existing legacy of logs and logging libraries. And this is the main design philosophy of OpenTelemetry logs.
