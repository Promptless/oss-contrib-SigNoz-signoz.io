...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/01/cloudwatch-metrics-namespace.webp" alt="Namespaces in Cloudwatch metrics monitoring"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/01/cloudwatch-metrics-dimensions.webp" alt="Dimensions in Cloudwatch metrics"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/01/cloudwatch-metrics-data.webp" alt="Metrics data in Amazon Cloudwatch"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/01/cloudwatch-metrics-high-cost.webp" alt="Users discussing high costs with Cloudwatch"/>
    <figcaption><i>Users discussing high costs with Cloudwatch</i></figcaption>
</figure>


<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/01/cloudwatch-metrics-cost-unpredictable.webp" alt="Sometimes CloudWatch costs can be unpredictable"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/01/cloudwatch-metrics-dashboard.webp" alt="Metrics dashboard in SigNoz"/>
