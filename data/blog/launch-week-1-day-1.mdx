...
<span className="mb-4 inline-block rounded border border-gray-300 bg-gray-200 px-2 py-0.5 text-[75%] font-bold leading-none text-gray-900">Launch Week 1.0</span>


# Feature in Spotlight: Logs Explorer [Day 1] 🪵

<div className="flex items-center gap-4">
  <a href="https://www.linkedin.com/in/ankit-anand-686a53a1/" className="block">
    <img alt="Ankit Profile" src="/img/users/ankit-anand.webp" className="h-12 w-12 rounded-full" />
  </a>
  <div className="flex flex-col gap-1">
    <div className="font-bold">Ankit Anand</div>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/events/launch-week-1/launch-week-day-1-cover.webp" alt="Launch week day 1 cover"/>
</figure>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/events/launch-week-1/logs-builder.webp" alt="Logs Explorer Builder"/>
</figure>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/events/launch-week-1/histograms.webp" alt="Histogram in Logs Explorer"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/events/launch-week-1/expanded-view-log-line.webp" alt="Expanded view of a log line"/>
...
- **Search Filter:**<br></br>
    ...
    <figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/events/launch-week-1/search-filter.webp" alt="Search applied for `container_id=debian`"/>
...
- **Advanced Query Builder:**<br></br>
    ...
    <figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/events/launch-week-1/advanced-logs-query-builder.webp" alt="Advanced query builder"/>
...
<figure data-zoomable align='center'>
<img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/events/launch-week-1/logs-traces.webp" alt="Traced to logs"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/events/launch-week-1/json-filter.gif" alt=""/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/events/launch-week-1/add-to-dashboard.gif" alt=""/>
    <figcaption><i></i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
<img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/events/launch-week-1/create-alerts.webp" alt="Traced to logs"/>
...
<figure data-zoomable align='center'>
<img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/events/launch-week-1/save-view.gif" alt="Traced to logs"/>
</figure>
...
- **Make data filtering more intuitive**<br></br>
    ...
    <figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/events/launch-week-1/new-time-filter.webp" alt="Time picker"/>
...
- **Increasing Data Density Without Sacrificing Usability**<br></br>
    ...
    <figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/events/launch-week-1/logs-explorer-full.webp" alt="Increasing data density"/>
...
- **Balancing Simplicity & Configurability**<br></br>
    ...
    <figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/events/launch-week-1/search-and-query-builder.gif" alt="Traced to logs"/>
    </figure>
...
- **Simplifying Complex Information**<br></br>
    ...
    <figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/events/launch-week-1/side-panel-logs.webp" alt="Logs Side Panel"/>
