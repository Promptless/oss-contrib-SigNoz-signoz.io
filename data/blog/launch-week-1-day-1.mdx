...
<figure data-zoomable align='center'>
    <OptimizedImg className="box-shadowed-image" src="/img/events/launch-week-1/launch-week-day-1-cover.webp" alt="Launch week day 1 cover"/>
</figure>
...
<figure data-zoomable align='center'>
    <OptimizedImg className="box-shadowed-image" src="/img/events/launch-week-1/logs-builder.webp" alt="Logs Explorer Builder"/>
</figure>
...
<figure data-zoomable align='center'>
    <OptimizedImg className="box-shadowed-image" src="/img/events/launch-week-1/histograms.webp" alt="Histogram in Logs Explorer"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg className="box-shadowed-image" src="/img/events/launch-week-1/expanded-view-log-line.webp" alt="Expanded view of a log line"/>
...
- **Search Filter:**<br></br>
    ...
    <figure data-zoomable align='center'>
    <OptimizedImg className="box-shadowed-image" src="/img/events/launch-week-1/search-filter.webp" alt="Search applied for `container_id=debian`"/>
...
- **Advanced Query Builder:**<br></br>
    ...
    <figure data-zoomable align='center'>
    <OptimizedImg className="box-shadowed-image" src="/img/events/launch-week-1/advanced-logs-query-builder.webp" alt="Advanced query builder"/>
...
<figure data-zoomable align='center'>
<OptimizedImg className="box-shadowed-image" src="/img/events/launch-week-1/logs-traces.webp" alt="Traced to logs"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg className="box-shadowed-image" src="/img/events/launch-week-1/json-filter.gif" alt=""/>
...
<figure data-zoomable align='center'>
    <OptimizedImg className="box-shadowed-image" src="/img/events/launch-week-1/add-to-dashboard.gif" alt=""/>
    <figcaption><i></i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
<OptimizedImg className="box-shadowed-image" src="/img/events/launch-week-1/create-alerts.webp" alt="Traced to logs"/>
...
<figure data-zoomable align='center'>
<OptimizedImg className="box-shadowed-image" src="/img/events/launch-week-1/save-view.gif" alt="Traced to logs"/>
</figure>
...
- **Make data filtering more intuitive**<br></br>
    ...
    <figure data-zoomable align='center'>
    <OptimizedImg className="box-shadowed-image" src="/img/events/launch-week-1/new-time-filter.webp" alt="Time picker"/>
...
- **Increasing Data Density Without Sacrificing Usability**<br></br>
    ...
    <figure data-zoomable align='center'>
    <OptimizedImg className="box-shadowed-image" src="/img/events/launch-week-1/logs-explorer-full.webp" alt="Increasing data density"/>
...
- **Balancing Simplicity & Configurability**<br></br>
    ...
    <figure data-zoomable align='center'>
    <OptimizedImg className="box-shadowed-image" src="/img/events/launch-week-1/search-and-query-builder.gif" alt="Traced to logs"/>
    </figure>
...
- **Simplifying Complex Information**<br></br>
    ...
    <figure data-zoomable align='center'>
    <OptimizedImg className="box-shadowed-image" src="/img/events/launch-week-1/side-panel-logs.webp" alt="Logs Side Panel"/>
