...
<div className="flex flex-wrap">
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      ...
      <a
         href="https://github.com/sf-pchakraborty" className="block">
         <img
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Priyanka Chakraborty</div>
...
<div className="flex flex-wrap">
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/rw4nn" className="block">
         <img
            alt="Rw4nn"
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Rw4nn</div>
         <small className="text-sm text-signoz_vanilla-400">
         </small>
      </div>
      </div>
    ...
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/blakeromano" className="block">
         <img
            alt="Blake R Profile"
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Blake R</div>
         <small className="text-sm text-signoz_vanilla-400">
         </small>
      </div>
      </div>
