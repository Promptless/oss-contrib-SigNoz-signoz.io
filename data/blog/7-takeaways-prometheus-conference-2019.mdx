...
---
<a href="https://promcon.io/" target="_blank" rel="noopener noreferrer nofollow">PromCon</a> is one of the premier conferences on Prometheus and related tools like Grafana. This is held every year where developers from around the world gather to learn the latest in monitoring technologies.
...
<a href="https://github.com/SigNoz/signoz" target="_blank" rel="noopener noreferrer nofollow"> Check it here </a>
...
2. **Validate and test alert definitions before making them live**
   ...
   <a href="https://twitter.com/simonhiker" target="_blank" rel="noopener noreferrer nofollow">Simon Pasquier</a> from Red Hat gave a great talk on details of alert manager, how to configure and validate them before making live in production environments. He is the maintainer for _Alertmanager_ and* consul_exporter  *projects*, * so what he says carries some weight.
...
3. **Understanding Routing of alerts**
   ...
   - Use <a href="https://github.com/prometheus/alertmanager/tree/master/cmd/amtool" target="_blank" rel="noopener noreferrer nofollow">amtool</a> or <a href="https://prometheus.io/webtools/alerting/routing-tree-editor/" target="_blank" rel="noopener noreferrer nofollow">routing tree editor</a> to test/validate as shown in figure 5
...
4. **Using Silence and Inhibitions when debugging issues | HA of alert manager**
   ...
   - Use gossip protocol to replicate all the information in the alert manager cluster- Based on the <a href="https://github.com/hashicorp/memberlist" target="_blank" rel="noopener noreferrer nofollow">hashicorp/memberlist</a> library
...
5. **Capacity Planning Using Prometheus**
   ...
   <a href="https://promcon.io/2019-munich/speakers/andrew-newdigate" target="_blank" rel="noopener noreferrer nofollow">Andrew Newdigate</a> from **GitLab** gave a great presentation on how their team used Prometheus to monitor issues caused because of resource saturation. Resource saturation could occur for any of the following resources:
...
<a href="https://dashboards.gitlab.com/d/general-capacity-planning/general-capacity-planning?orgId=1" target="_blank" rel="noopener noreferrer nofollow">Capacity Planning dashboard used by Gitlab</a>
