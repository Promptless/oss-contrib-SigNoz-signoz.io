...
<div className="flex flex-wrap">
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      ...
      <a
         href="https://github.com/lucasmellos" className="block">
         <img
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Lucas Mellos Carlos</div>
    ...
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/katepangLiu" className="block">
         <img
            alt="KatePang"
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">KatePang</div>
         <small className="text-sm text-signoz_vanilla-400">
         </small>
      </div>
      </div>
