...
The Grafana dashboard import feature mentioned in this blog was introduced in version <a href="https://github.com/SigNoz/signoz/releases/tag/v0.11.4" target="_blank" rel="noopener noreferrer nofollow">v0.11.4</a>. However, this feature has been deprecated and is no longer supported.

Explore the list of pre-built dashboards <a href="https://github.com/SigNoz/dashboards" target="_blank" rel="noopener noreferrer nofollow">here</a>. If you need something specific, you can <a href="https://github.com/SigNoz/signoz/issues/new?assignees=&amp;labels=dashboard-template&amp;p[%E2%80%A6]s=&amp;template=request_dashboard.md&amp;title=%5BDashboard+Request%5D+" target="_blank" rel="noopener noreferrer nofollow">request a new dashboard</a>.
</Admonition>
...
We urge our users to make <a href="https://github.com/SigNoz/signoz/issues" target="_blank" rel="noopener noreferrer nofollow">GitHub issues</a> of any improvements they identify and want us to take it up.
...
- <a href="https://github.com/SigNoz/signoz/issues/1797" target="_blank" rel="noopener noreferrer nofollow">Metrics to Traces correlation</a>
- <a href="https://github.com/SigNoz/signoz/issues/1798" target="_blank" rel="noopener noreferrer nofollow">Metrics to Logs correlation</a>
- <a href="https://github.com/SigNoz/signoz/issues/1799" target="_blank" rel="noopener noreferrer nofollow">Logs to Traces correlation</a>
...
Our team had a great time interacting with the DevOps community at the annual DevOps Days India, 2022. <a href="https://www.linkedin.com/in/ankitnayan/" target="_blank" rel="noopener noreferrer nofollow">Ankit Nayan</a>, our CTO and co-founder, also presented a very engaging talk on our choice of data store with performance benchmarking!
