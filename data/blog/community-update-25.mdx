...
<div className="flex flex-wrap">
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      ...
      <a
         href="https://github.com/GermaVinsmoke" className="block">
         <img
            alt="Germa Vinsmoke"
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Germa Vinsmoke</div>
...
<div className="flex flex-wrap">
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/ksorv" className="block">
         <img
            alt="Saurav Khdoolia"
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Saurav Khdoolia</div>
         <small className="text-sm text-signoz_vanilla-400">
         </small>
      </div>
      </div>
    ...
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/andrewjanssen" className="block">
         <img
            alt="Janssen"
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Janssen</div>
         <small className="text-sm text-signoz_vanilla-400">
         </small>
      </div>
      </div>
...
<div className="flex flex-wrap">
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/yeshev" className="block">
         <img
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Yevhen Shevchenko</div>
         <small className="text-sm text-signoz_vanilla-400">
         </small>
      </div>
      </div>
    ...
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/ww9" className="block">
         <img
            alt="Bruno Cassol"
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Bruno Cassol</div>
         <small className="text-sm text-signoz_vanilla-400">
         </small>
      </div>
      </div>
...
<div className="flex flex-wrap">
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/vinyasmusic" className="block">
         <img
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Vinyas Malagaudanavar</div>
         <small className="text-sm text-signoz_vanilla-400">
         </small>
      </div>
      </div>
    ...
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/akshay-bharadva" className="block">
         <img
            alt="Akshay Bharadva"
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Akshay Bharadva</div>
         <small className="text-sm text-signoz_vanilla-400">
         </small>
      </div>
      </div>
