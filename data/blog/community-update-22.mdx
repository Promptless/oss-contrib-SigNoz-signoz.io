...
<div className="flex flex-wrap">
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      ...
      <a
         href="https://github.com/KolesnikAntony" className="block">
         <img
            alt="Kolesnyk Anton"
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Kolesnyk Anton</div>
    ...
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/fcpimenta" className="block">
         <img
            alt="fcpimenta"
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Fernando Pimenta</div>
         <small className="text-sm text-signoz_vanilla-400">
         </small>
      </div>
      </div>
...
<div className="flex flex-wrap">
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/ezioruan" className="block">
         <img
            alt="ezioruan"
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Ezio Ruan</div>
         <small className="text-sm text-signoz_vanilla-400">
         </small>
      </div>
      </div>
    ...
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/jyash97" className="block">
         <img
            alt="yash97"
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Yash Joshi</div>
         <small className="text-sm text-signoz_vanilla-400">
         </small>
      </div>
      </div>
...
<div className="flex flex-wrap">
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/asny23" className="block">
         <img
            alt="asny23"
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">yun asny23</div>
         <small className="text-sm text-signoz_vanilla-400">
         </small>
      </div>
      </div>
