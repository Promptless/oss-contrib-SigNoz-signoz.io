...
After this, you should be able to successfully launch the server on <a href="http://localhost:4000/graphql" target="_blank" rel="noopener noreferrer nofollow">http://localhost:4000/graphql</a>
...
Check the final server application here: <a href="https://github.com/SigNoz/angular-graphql-example/tree/master/server" target="_blank" rel="noopener noreferrer nofollow">Server application for Angular GraphQL app</a>
...
Now the application will be running on <a href="http://localhost:4200" target="_blank" rel="noopener noreferrer nofollow">http://localhost:4200</a>
...
You can find the code for this tutorial on GitHub at: <a href="https://github.com/SigNoz/angular-graphql-example" target="_blank" rel="noopener noreferrer nofollow">Angular GraphQL example with Apollo Client</a>
