...
Recently, Uber also moved from <a href="https://eng.uber.com/logging/" target="_blank" rel="noopener noreferrer nofollow">Elastic to ClickHouse</a> as their database for their logs infra because they found that 60-70% of their logs queries were aggregation queries and columnar databases are designed for such queries and perform much faster.
...
Here's a <a href="https://www.honeycomb.io/blog/why-observability-requires-distributed-column-store/" target="_blank" rel="noopener noreferrer nofollow">blog</a> by Honeycomb where they talk in detail about why columnar databases are more suited for observability. They focus primarily on tracing and high cardinality, but the point around being able to ask questions from your observability system broadly holds.
