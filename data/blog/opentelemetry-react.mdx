...
<a href="https://github.com/SigNoz/sample-reactjs-app/tree/master" target="_blank" rel="noopener noreferrer nofollow">Sample React App</a><br></br>
...
You can view the file at <a href="https://github.com/SigNoz/signoz/blob/main/deploy/docker/otel-collector-config.yaml" target="_blank" rel="noopener noreferrer nofollow">SigNoz GitHub repo</a>. Inside the file add the following CORS config:
