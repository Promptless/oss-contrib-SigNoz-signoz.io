...
<figure align="center">
  <OptimizedImg src="/img/blog/2022/02/signoz_dashboard.webp" alt="SigNoz Dashboard" width="100%" />
...
<figure align="center">
  <OptimizedImg src="/img/blog/2022/04/grpc_application_architecture.webp" alt="Application architecture" width="70%" />
...
<figure align="center">
  <OptimizedImg src="/img/blog/2022/04/opentelemetry_grpc_libraries.webp" alt="OpenTelemetry libraries required for monitoring gRPC" width="100%" />
</figure>
...
{ /* <!-- ![.env files loading in both *server/server.go* and *client/client.go.*](Ashu%20-%20Mon%2092dcf/Untitled%203.webp) --> */}
 ...
 { /* <!-- <figure align="center">
   <OptimizedImg src="/img/blog/2022/04/grpc_env_files.webp" alt="Environment files" width="90%" />
...
<figure align="center">
  <OptimizedImg src="/img/blog/2022/04/grpc_mongodb_connection.webp" alt="MongoDB Data Connection" width="90%" />
</figure>  

1. Click on Databases tab → Create Database and fill in the fields like the below screenshot
<figure align="center">
  <OptimizedImg src="/img/blog/2022/04/grpc_create_database.webp" alt="Create Database" width="80%" />
</figure>
...
<figure align="center">
  <OptimizedImg src="/img/blog/2023/08/grpc_monitored_on_signoz.webp" alt="Golang gRPC application monitored in SigNoz" width="100%" />
...
<figure align="center">
  <OptimizedImg src="/img/blog/2022/04/grpc_top_endpoints.webp" alt="List of Top endpoints" width="100%" />
...
<figure align="center">
  <OptimizedImg src="/img/blog/2022/04/grpc_span_table.webp" alt="Spans Table" width="100%" />
...
<figure align="center">
  <OptimizedImg src="/img/blog/2022/04/grpc_flamegraph.webp" alt="Flamegraphs to visualize how a complete request performed" width="100%" />
...
<figure align="center">
  <OptimizedImg src="/img/blog/2022/04/grpc_mongodb_traces.webp" alt="Traces for MongoDB" width="100%" />
...
<figure align="center">
  <OptimizedImg src="/img/blog/2022/04/grpc_error_troubleshooting.webp" alt="Troubleshooting an error" width="100%" />
