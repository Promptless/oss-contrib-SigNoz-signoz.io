...
<figure data-zoomable align='center'>
    <OptimizedImg src="/img/blog/common/ingestion-key-details.webp" alt="Find ingestion settings in SigNoz dashboard"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg className="box-shadowed-image" src="/img/blog/2024/01/opentelemetry-docker-metrics.webp" alt="Docker container metrics collected by OpenTelemetry collector"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg className="box-shadowed-image" src="/img/blog/2024/01/opentelemetry-docker-create-dashboard.webp" alt="Creating a dashboard panel for average memory usage per container"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg className="box-shadowed-image" src="/img/blog/2024/01/opentelemetry-docker-dashboard-panel.webp" alt="Dashboard for monitoring Docker Container Metrics in SigNoz"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg className="box-shadowed-image" src="/img/blog/2024/01/opentelemetry-docker-alerts.webp" alt="Create alerts on any Docker container metrics"/>
