...
We have a <a href="https://github.com/SigNoz/examples" target="_blank" rel="noopener noreferrer nofollow">GitHub repository</a> containing all the configuration files and scripts used in this guide. Clone it by running:
