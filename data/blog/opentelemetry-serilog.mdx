...
To provide a separation of concerns between Serilog and the application logic, we have scoped all static configuration to the <a href="https://github.com/SigNoz/examples/blob/main/dot-net/serilog-opentelemetry-demo/appsettings.json" target="_blank" rel="noopener noreferrer nofollow">appsettings.json</a>. Let’s go through the relevant configuration:
