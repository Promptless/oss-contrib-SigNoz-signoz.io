...
You should start seeing the metrics on your Signoz Cloud UI in about 30 seconds. You can import this <a href="https://github.com/SigNoz/dashboards/tree/main/nginx" target="_blank" rel="noopener noreferrer nofollow">dashboard JSON</a> into your SigNoz environment to start monitoring your Nginx instance quickly.
