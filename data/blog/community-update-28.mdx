...
<div className="flex flex-wrap">
   <div className="flex-[0_0_50%] max-w-[50%] px-4">
      ...
      <a
         href="https://github.com/gaida" className="block">
         <img
            alt="Martin Gaida"
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Martin Gaida</div>
    ...
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/YounixM" className="block">
         <img
            alt="Yunus M"
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Yunus M</div>
         <small className="text-sm text-signoz_vanilla-400">
         </small>
      </div>
      </div>
...
<div className="flex flex-wrap">
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/rybnico" className="block">
         <img
            alt="Nico"
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Nico</div>
         <small className="text-sm text-signoz_vanilla-400">
         </small>
      </div>
      </div>
    ...
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/Damans227" className="block">
         <img
            alt="Daman Arora"
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Daman Arora</div>
         <small className="text-sm text-signoz_vanilla-400">
         </small>
      </div>
      </div>
...
<div className="flex flex-wrap">
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/shivanshuraj1333" className="block">
         <img
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Shivanshu Raj Shrivastava</div>
         <small className="text-sm text-signoz_vanilla-400">
         </small>
      </div>
      </div>
    ...
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/nodaddy" className="block">
         <img
            alt="Neelesh Sharma"
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Neelesh Sharma</div>
         <small className="text-sm text-signoz_vanilla-400">
         </small>
      </div>
      </div>
...
<div className="flex flex-wrap">
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/rchallie" className="block">
         <img
            alt="Romain Challier"
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Romain Challier</div>
         <small className="text-sm text-signoz_vanilla-400">
         </small>
      </div>
      </div>
    ...
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/serverless-mom" className="block">
         <img
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Nočnica Mellifera</div>
         <small className="text-sm text-signoz_vanilla-400">
         </small>
      </div>
      </div>
...
<div className="flex flex-wrap">
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/dhawal1248" className="block">
         <img
            alt="Dhawal Sanghvi"
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Dhawal Sanghvi</div>
         <small className="text-sm text-signoz_vanilla-400">
         </small>
      </div>
      </div>
    ...
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/RecoX" className="block">
         <img
            alt="Lucas Recoaro"
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Lucas Recoaro</div>
         <small className="text-sm text-signoz_vanilla-400">
         </small>
      </div>
      </div>
...
<div className="flex flex-wrap">
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/TheEpic-dev" className="block">
         <img
            alt="TheEpic-dev"
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">TheEpic-dev</div>
         <small className="text-sm text-signoz_vanilla-400">
         </small>
      </div>
      </div>
