...
When you are done installing SigNoz, you can access the UI at: <a href="http://localhost:3301" target="_blank" rel="noopener noreferrer nofollow">http://localhost:3301</a>
...
You need to ensure that you have **Node.js version 12 or newer**. You can download the latest version of Node.js <a href="https://nodejs.org/en/download/" target="_blank" rel="noopener noreferrer nofollow">here</a>. For the sample application, let's create a basic 'hello world' express.js application.
...
3. **Run your application**<br></br>
   ...
   You can check your application running at <a href="http://localhost:5555/" target="_blank" rel="noopener noreferrer nofollow">http://localhost:5555/</a>. You need to generate some load in order to see data reported on SigNoz dashboard. Refresh the endpoint for 10-20 times, and wait for 2-3 mins.

And, congratulations! You have instrumented your sample Node.js app. You can now access the SigNoz dashboard at <a href="http://localhost:3301" target="_blank" rel="noopener noreferrer nofollow">http://localhost:3301</a> to monitor your app for performance metrics.
