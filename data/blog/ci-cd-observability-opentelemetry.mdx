...
3. **Explore Your CI/CD Metrics in SigNoz**
    ...
    Once configured, use <a href="https://github.com/SigNoz/dashboards/blob/main/cicd/cicd.json" target="_blank" rel="noopener noreferrer nofollow">SigNoz dashboards</a> to monitor builds, deployments, and pipeline health in real time.

## Analyzing SigNoz/charts repository

Let’s take a look at our <a href="https://github.com/SigNoz/charts" target="_blank" rel="noopener noreferrer nofollow">charts</a> repository and try to gain some insight into what is happening. 
...
Join the SigNoz community on <a href="https://app.slack.com/client/T01HWUTP0LT#/domain-signup" target="_blank" rel="noopener noreferrer nofollow">Slack</a> or GitHub, share your experience, and help us shape the future of observability. Your feedback directly drives what we build next.
