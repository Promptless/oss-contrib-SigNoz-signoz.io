...
<div className="flex flex-wrap">
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Medicharla Chiranjeevi</div>
    ...
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/cdemi" className="block">
         <img
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Christopher Demicoli</div>
         <small className="text-sm text-signoz_vanilla-400">
            India
         </small>
      </div>
...
<div className="flex flex-wrap">
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/dchennaraidu" className="block">
         <img
            alt="Medicharla Chiranjeevi profile"
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Chenna Raidu D</div>
         <small className="text-sm text-signoz_vanilla-400">
         India
         </small>
      </div>
