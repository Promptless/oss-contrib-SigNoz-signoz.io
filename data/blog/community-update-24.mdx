...
<div className="flex flex-wrap">
    ...
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">GermaVinsmoke</div>
         <small className="text-sm text-signoz_vanilla-400">
         </small>
      </div>
      </div>
...
<div className="flex flex-wrap">
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/daniel-t4e" className="block">
         <img
            alt="Daniël"
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Daniël</div>
         <small className="text-sm text-signoz_vanilla-400">
         </small>
      </div>
      </div>
    ...
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/erplsf" className="block">
         <img
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Andriy Mykhaylyk</div>
         <small className="text-sm text-signoz_vanilla-400">
         </small>
      </div>
      </div>
...
<div className="flex flex-wrap">
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/czchen" className="block">
         <img
            alt="ChangZhuo Chen"
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">ChangZhuo Chen</div>
         <small className="text-sm text-signoz_vanilla-400">
         </small>
      </div>
      </div>
