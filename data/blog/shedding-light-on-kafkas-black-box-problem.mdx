...
The OTel collector offers a <a href="https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/main/receiver/jmxreceiver" target="_blank" rel="noopener noreferrer nofollow">JMX receiver</a> that works in conjunction with the OTel <a href="https://github.com/open-telemetry/opentelemetry-java-contrib/blob/main/jmx-metrics/README.md" target="_blank" rel="noopener noreferrer nofollow">JMX Metric Gatherer</a>. This setup allows for the collection of Kafka metrics and their conversion into the OpenTelemetry Protocol (OTLP) format for further analysis.
