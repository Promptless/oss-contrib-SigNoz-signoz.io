...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2023/12/loki_promtail.webp" alt=""/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2023/12/loki_logs_tab_option1.webp" alt="Logs tab options"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2023/12/loki_log_explorer_tab.webp" alt="Logs Explorer tab"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2023/12/loki_logs_tab_option2.webp" alt="Logs tab options"/>
    <figcaption><i>Logs tab options</i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2023/12/loki_logs_pipeline_page.webp" alt="Logs Pipelines page"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2023/12/loki_creating_the_pipeline.webp" alt="Creating the pipeline"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2023/12/loki_adding_processor.webp" alt="Adding a processor"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2023/12/loki_processor_types.webp" alt="Processor types"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2023/12/loki_regex_settings.webp" alt="Regex settings"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2023/12/loki_unprocessed_logs.webp" alt="Unprocessed logs"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2023/12/loki_initial_logs_format.webp" alt="The initial format of the logs"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2023/12/loki_processed_output.webp" alt="Processed output"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2023/12/loki_processed_log_format.webp" alt="Processed logs format"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2023/12/loki_pipeline_deployment.webp" alt="Pipeline deployment"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2023/12/loki_new_query_option.webp" alt="New query options/fields"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2023/12/loki_query_builder.webp" alt="Query builder"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2023/12/loki_settup_alert_query.webp" alt="Setup alert from query"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2023/12/loki_choose_metrics.webp" alt="Choosing your metrics"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2023/12/loki_alert_condition.webp" alt="Alert condition and configuration"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2023/12/loki_alert_rules.webp" alt="Alert Rules"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2023/12/loki_triggered_alerts.webp" alt="Triggered alerts"/>
