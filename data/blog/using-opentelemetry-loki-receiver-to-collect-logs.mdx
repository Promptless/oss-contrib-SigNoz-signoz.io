...
To see Promtail running, visit <a href="http://localhost:9080/targets" target="_blank" rel="noopener noreferrer nofollow">localhost:9080/targets</a> on your browser.
