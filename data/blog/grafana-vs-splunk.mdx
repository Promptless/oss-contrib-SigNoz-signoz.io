...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/02/splunk-data-query.webp" alt="Grafana vs Splunk: Data Query"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/02/grafana-data-query.webp" alt="Grafana vs Splunk: Data Query"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2023/02/splunk_log_observer.webp" alt="Splunk Log Observer (Source: Splunk website"/>
...
<figure data-zoomable align='center'>
    <img  className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/02/grafana-viz.webp" alt="Grafana dashboard visualizing application metrics (Source: Grafana website"/>
