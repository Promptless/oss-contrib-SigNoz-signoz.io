...
<figure data-zoomable align='center'>
    <OptimizedImg className="box-shadowed-image" src="/img/blog/2024/02/splunk-data-query.webp" alt="Grafana vs Splunk: Data Query"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg className="box-shadowed-image" src="/img/blog/2024/02/grafana-data-query.webp" alt="Grafana vs Splunk: Data Query"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg className="box-shadowed-image" src="/img/blog/2023/02/splunk_log_observer.webp" alt="Splunk Log Observer (Source: Splunk website"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg  className="box-shadowed-image" src="/img/blog/2024/02/grafana-viz.webp" alt="Grafana dashboard visualizing application metrics (Source: Grafana website"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg src="/img/blog/common/signoz_charts_application_metrics.webp" alt="Application Metrics Dashboard in SigNoz"/>
