...
<div className="flex flex-wrap">
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      ...
      <a
         href="https://github.com/euclidesflores" className="block">
         <img
            alt="Euclides Flores"
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Euclides Flores</div>
    ...
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/rkmdCodes" className="block">
         <img
            alt="Rajat Dwivedi"
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Rajat Dwivedi</div>
         <small className="text-sm text-signoz_vanilla-400">
         </small>
      </div>
      </div>
...
<div className="flex flex-wrap">
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/adderek" className="block">
         <img
            alt="Maciej Wakuła"
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Maciej Wakuła</div>
         <small className="text-sm text-signoz_vanilla-400">
         </small>
      </div>
      </div>
    ...
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/maryojo" className="block">
         <img
            alt="Mary Ojo"
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Mary Ojo</div>
         <small className="text-sm text-signoz_vanilla-400">
         </small>
      </div>
      </div>
...
<div className="flex flex-wrap">
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/ahsanbarkati" className="block">
         <img
            alt="Ahsan Barkati"
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Ahsan Barkati</div>
         <small className="text-sm text-signoz_vanilla-400">
         </small>
      </div>
      </div>
   ...
   <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/nicot4e" className="block">
         <img
            alt="nicot4e"
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">nicot4e</div>
         <small className="text-sm text-signoz_vanilla-400">
         </small>
      </div>
      </div>
...
<div className="flex flex-wrap">
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/sthomson-wyn" className="block">
         <img
            alt="Stewart Thomson"
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Stewart Thomson</div>
         <small className="text-sm text-signoz_vanilla-400">
         </small>
      </div>
      </div>
    ...
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/nickb937" className="block">
         <img
            alt="Mary Ojo"
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Nick Burrett</div>
         <small className="text-sm text-signoz_vanilla-400">
         </small>
      </div>
      </div>
