...
See the state of <a href="https://opentelemetry.io/docs/instrumentation/" target="_blank" rel="noopener noreferrer nofollow">OpenTelmetry language libraries</a> to keep track of which languages may soon add more auto-instrumentation features.
