...
<figure data-zoomable align='center'>
    <OptimizedImg src="/img/blog/2022/05/otel_mongodb_promql.webp" alt="You can write PromQL queries to create custom dashboards"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg src="/img/blog/2022/05/mongodb_custom_dashboards.webp" alt="MongoDB custom dashboards showing metrics like total number of requests"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg src="/img/blog/2022/05/otel_mongodb_database_calls.webp" alt="Database calls tab on SigNoz dashboard showing important metrics about database calls from a specific services"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg src="/img/blog/2022/05/otel_mongodb_trace_details.webp" alt="Trace visualization of MongoDB calls using Flamegraphs on SigNoz dashboard"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg src="/img/blog/2022/05/otel_mongodb_database_error.webp" alt="Trace visualization of MongoDB calls using Flamegraphs on SigNoz dashboard"/>
    <figcaption><i>Trace visualizing a database calls which results in error on SigNoz dashboard</i></figcaption>
</figure>


<figure data-zoomable align='center'>
    <OptimizedImg src="/img/blog/2022/05/otel_mongodb_404.webp" alt="Trace visualization of MongoDB calls using Flamegraphs on SigNoz dashboard"/>
