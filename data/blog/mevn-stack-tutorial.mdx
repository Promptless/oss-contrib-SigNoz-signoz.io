...
**Step 7:** Scroll down and whitelist the <a href="http://localhost" target="_blank" rel="noopener noreferrer nofollow">localhost</a> IP in order to be able to connect with MongoDB atlas. Then click on `Add Entry` → `Finish and Close`.
