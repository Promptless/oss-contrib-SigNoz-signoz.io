...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/04/signal-35-cover.webp" alt="SigNal 35 cover image"/>
</figure>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/04/signal-35-integrations.webp" alt="Create dashboards with important logs and metrics quickly with the help of integrations"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/04/signal-35-mongodb-integration.webp" alt="MongoDB integration in SigNoz lets you collect logs and metrics from your MongoDB instance"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/04/signal-35-email-notification.webp" alt="You can configure Emails as a notification channel"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/04/signal-35-setup-alert.webp" alt="Set up alerts in case of missing data"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/04/signal-35-alert-frequency.webp" alt="You can now customize the alert frequency"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/04/signal-35-download-logs.webp" alt="Download logs in excel and csv format"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/04/signal-35-clone-query.webp" alt="Clone a query to start building complex queries faster in our query builder"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/04/signal-35-spent.webp" alt="Get complete visibility on what’s driving your observability costs"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/04/signal-35-filtering.webp" alt="Filter services by their environment—like dev, prod, and staging"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/04/signal-35-pin-attributes.webp" alt="Pin commonly occurring attributes in the logs context tab"/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/04/signal-35-kubecon.webp" alt=""/>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/04/signal-35-signoz-over-grafana.webp" alt=""/>
    <figcaption><i></i></figcaption>
</figure>
...
<figure data-zoomable align='center'>
    <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" src="/img/blog/2024/04/signal-35-twitter.webp" alt=""/>
    <figcaption><i></i></figcaption>
</figure>
...
<div className="flex flex-wrap">
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      ...
      <a
         href="https://github.com/grandwizard28" className="block">
         <img
            alt="Vibhu Pandey"
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Vibhu Pandey</div>
    ...
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/wbtan7" className="block">
         <img
            alt="Tan Wei Been"
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Tan Wei Been</div>
         <small className="text-sm text-signoz_vanilla-400">
         </small>
      </div>
      </div>
...
<div className="flex flex-wrap">
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/legendary-acp" className="block">
         <img
            alt="Pradyuman"
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Pradyuman</div>
         <small className="text-sm text-signoz_vanilla-400">
         </small>
      </div>
      </div>
    ...
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/weastel" className="block">
         <img
            alt="Drumil Patel"
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Drumil Patel</div>
         <small className="text-sm text-signoz_vanilla-400">
         </small>
      </div>
      </div>
