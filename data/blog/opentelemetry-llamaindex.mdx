...
Want to explore the RAG chatbot in action? Clone the <a href="https://github.com/SigNoz/llamaindex-rag-opentelemetry-demo" target="_blank" rel="noopener noreferrer nofollow">repo</a>, install dependencies, and follow the setup steps in the <a href="https://github.com/SigNoz/llamaindex-rag-opentelemetry-demo/blob/main/README.md" target="_blank" rel="noopener noreferrer nofollow">README</a> to start sending traces and logs from your local app to SigNoz.
