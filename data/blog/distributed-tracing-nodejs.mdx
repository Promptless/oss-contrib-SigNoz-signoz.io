...
- Node JS 14 or newer<br></br>
  Download the <a href="https://nodejs.org/en/download/" target="_blank" rel="noopener noreferrer nofollow">latest version</a>.
- MySql 8
- SigNoz
...
If you have MySQL already installed and is configured with a password, you might need to update the password in the sample app <a href="https://github.com/SigNoz/distributed-tracing-nodejs-sample/blob/d34e63d3bf6c996c020a58a05d84a39132934e5d/src/model/index.ts#L6" target="_blank" rel="noopener noreferrer nofollow">here</a>.
...
1. **Clone sample nodejs app repository and go to the root folder**<br></br>
   We will be using a sample nodejs app at this <a href="https://github.com/SigNoz/distributed-tracing-nodejs-sample" target="_blank" rel="noopener noreferrer nofollow">GitHub repo</a>.
...
3. **`tracer.ts` file**<br></br>
   ...
   You can check out the code sample <a href="https://github.com/SigNoz/distributed-tracing-nodejs-sample/blob/main/src/tracer.ts" target="_blank" rel="noopener noreferrer nofollow">here</a>.
...
4. **Setting up SigNoz as the [OpenTelemetry backend](https://signoz.io/blog/opentelemetry-backend/)**<br></br>
   ...
   You can check the file <a href="https://github.com/SigNoz/distributed-tracing-nodejs-sample/blob/main/package.json" target="_blank" rel="noopener noreferrer nofollow">here</a>.
...
5. **Run the microservices**<br></br>
   ...
   You can check the <a href="https://github.com/SigNoz/distributed-tracing-nodejs-sample/blob/main/.env" target="_blank" rel="noopener noreferrer nofollow">file</a> in the cloned repo.
...
This will run the app UI on port 5000. Open the UI at <a href="http://localhost:5000/" target="_blank" rel="noopener noreferrer nofollow">http://localhost:5000/</a>.
