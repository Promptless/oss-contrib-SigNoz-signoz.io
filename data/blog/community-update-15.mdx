...
<div className="flex flex-wrap">
    ...
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/Natrinicle" className="block">
         <img
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Natrinicle</div>
         <small className="text-sm text-signoz_vanilla-400">
         </small>
      </div>
      </div>
...
<div className="flex flex-wrap">
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/medicharlachiranjeevi" className="block">
         <img
            alt="Chiranjeevi"
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Chiranjeevi</div>
         <small className="text-sm text-signoz_vanilla-400">
         </small>
      </div>
      </div>
    ...
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/jshiwam" className="block">
         <img
            alt="Shiwam Profile"
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Shiwam</div>
         <small className="text-sm text-signoz_vanilla-400">
         </small>
      </div>
      </div>
...
<div className="flex flex-wrap">
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/AkshayAwate" className="block">
         <img
            alt="Akshay"
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Akshay Awate</div>
         <small className="text-sm text-signoz_vanilla-400">
         </small>
      </div>
      </div>
    ...
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/zriyansh" className="block">
         <img
      ...
      <div className="flex flex-col gap-1">
         <div className="font-bold">Priyansh Khodiyar</div>
         <small className="text-sm text-signoz_vanilla-400">
         </small>
      </div>
      </div>
