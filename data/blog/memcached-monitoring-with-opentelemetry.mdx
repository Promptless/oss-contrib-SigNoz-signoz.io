...
<figure data-zoomable align='center'>
    <OptimizedImg className="box-shadowed-image" src="/img/blog/2023/11/memcached_metrics.webp" alt="Collected Memcached metrics for visualization"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg className="box-shadowed-image" src="/img/blog/2023/11/memcached_panels.webp" alt="Create Panels for monitoring different metrics of Memcached"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg className="box-shadowed-image" src="/img/blog/2023/11/memcached_dashboard.webp" alt="Memcached Monitoring Dashboard in SigNoz"/>
