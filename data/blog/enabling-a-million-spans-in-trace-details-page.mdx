...
This was our first key learning: **no matter what, dumping a million spans into the frontend won’t work.**
 ...
 So, we needed to restrict the number of elements rendered in the <a href="https://developer.mozilla.org/en-US/docs/Glossary/DOM" target="_blank" rel="noopener noreferrer nofollow">DOM</a> tree. A very popular concept of virtualisation came into the discussions.
