...
<figure data-zoomable align='center'>
    <OptimizedImg src="/img/blog/2022/07/o11y-net-trans.webp" alt="Telemetry signals are correlated"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg src="/img/blog/2023/02/context_and_propagators.webp" alt="Context and Propagators in Action"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg src="/img/blog/2023/02/otel_client_side_architecture.webp" alt="OpenTelemetry client-side Architecture"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg src="/img/blog/2023/02/otel_ref_implementations.webp" alt="OpenTelemetry Standard and Implementation Libraries support"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg src="/img/blog/2023/02/traces_combined_with_logs_and_metrics.webp" alt="How Otel fits in an application architecture"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg src="/img/blog/2023/02/otel_collector_pipeline.webp" alt="OpenTelemetry Collector Pipeline"/>
