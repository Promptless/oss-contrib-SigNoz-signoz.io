...
<figure data-zoomable align='center'>
    <OptimizedImg src="/img/blog/2021/09/jaeger_vs_zipkin_microservices_architecture.webp" alt="Microservices architecture"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg src="/img/blog/2021/09/opentelemetry_distributed_tracing-min.webp" alt="Trace context"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg src="/img/blog/2021/09/Jaeger_architecture-min.webp" alt="Jaeger architecture"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg src="/img/blog/2021/09/hotrod_application_ui-min.webp" alt="HotRod application webUI"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg src="/img/blog/2021/09/hotrod_app_customer_call-min.webp" alt="Backend responses"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg src="/img/blog/2022/09/jaeger_distributed_tracing.webp" alt="HOTrod application UI"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg src="/img/blog/2021/09/distributed_tracing_jaeger_reporting-min.webp" alt="Jaeger UI"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg src="/img/blog/2021/09/jaeger_dependency_graph-min.webp" alt="Jaeger dependency graph"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg src="/img/architecture-signoz-clickhouse.svg" alt="Architecture of SigNoz with OpenTelemetry and ClickHouse"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg src="/img/blog/common/signoz_charts_application_metrics.webp" alt="SigNoz UI showing the popular RED metrics"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg src="/img/blog/common/signoz_flamegraphs.webp" alt="Flamegraphs used to visualize spans of distributed tracing in SigNoz UI"/>
...
<figure data-zoomable align='center'>
    <OptimizedImg src="/img/blog/common/signoz_logs.webp" alt="Logs management in SigNoz"/>
