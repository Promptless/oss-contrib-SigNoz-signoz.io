...
One of the first responses that comes in on this thread mentions that <a href="https://clickhouse.com/docs/en/concepts/why-clickhouse-is-so-fast" target="_blank" rel="noopener noreferrer nofollow">Clickhouse provides better performance for observability</a> queries than Postgres. CNCF ambassador and member of Dynatrace Adam Gardener gives a good synopsis:
...
When it’s time to see your data in a dashboard, again you won’t want to use Postgres to store your data. Matthew Macdonald-Wallace of <a href="http://contino.io/" target="_blank" rel="noopener noreferrer nofollow">Contino.io</a> offers a great consideration
...
There are several projects built specifically to receive and process OpenTelemetry data, without having to start from scratch. One of these is <a href="https://github.com/signoz/signoz" target="_blank" rel="noopener noreferrer nofollow">SigNoz</a>.
