...
<OptimizedImg src="/img/blog/common/signoz_charts_application_metrics.webp" alt="SigNoz UI showing application overview metrics like RPS, 50th/90th/99th Percentile latencies, and Error Rate" width="724" height="360" priority />
...
<Figure src="/img/blog/2025/06/open-source-apm-tools-new-relic-vs-grafana-app-observability.webp" alt="Application observability in Grafana" caption="Application observability in Grafana" width="724" height="500" />
...
<Figure src="/img/blog/2025/06/open-source-apm-tools-image%201.webp" alt="Jaeger UI" caption="Jaeger UI" width="724" height="386" /> 
