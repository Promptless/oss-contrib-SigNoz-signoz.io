...
- Node.js version 12 or newer. Download the latest version of Node.js <a href="https://nodejs.org/en/download/" target="_blank" rel="noopener noreferrer nofollow">**here**</a>.

### Quick Start

To avoid manual setup, clone the <a href="https://github.com/SigNoz/sample-nodejs-app" target="_blank" rel="noopener noreferrer nofollow">sample Express.js app repository</a>, which is pre-configured with OpenTelemetry instrumentation. However, to fully understand the process, you are recommended to follow the steps below.
...
4. **Check if your application is working**
    ...
    You can check if your app is working by visiting <a href="http://localhost:5555/" target="_blank" rel="noopener noreferrer nofollow">**http://localhost:5555/**</a>
...
1. **Install OpenTelemetry Packages**
    ...
    💡 **Note**: If you run into any error, you might want to use these pinned versions of OpenTelemetry libraries used in <a href="https://github.com/SigNoz/sample-nodejs-app/blob/master/typescript/auto-no-code/package.json" target="_blank" rel="noopener noreferrer nofollow">this</a>.
...
3. **Start the Application**
    ...
    You can check your application running at <a href="http://localhost:5555/" target="_blank" rel="noopener noreferrer nofollow">**http://localhost:5555/**</a>. 
...
You can also install and self-host SigNoz yourself since it is open-source. With 19,000+ GitHub stars, <a href="https://github.com/signoz/signoz" target="_blank" rel="noopener noreferrer nofollow">**open-source SigNoz**</a> is loved by developers. Find the [**instructions**](https://signoz.io/docs/install/) to self-host SigNoz.
