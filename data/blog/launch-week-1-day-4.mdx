...
<OptimizedImg className="box-shadowed-image" src="/img/events/launch-week-1/launch-week-day-4-cover.webp" alt="Cover pic"/>
</figure>
...
<figure data-zoomable align='center'>
<OptimizedImg className="box-shadowed-image" src="/img/events/launch-week-1/logs-pipeline-builder.webp" alt="Cover pic"/>
</figure>
...
<figure data-zoomable align='center'>
<OptimizedImg className="box-shadowed-image" src="/img/events/launch-week-1/logs-demo-cart-service.webp" alt="Logs from a demo cart service"/>
...
<figure data-zoomable align='center'>
<OptimizedImg className="box-shadowed-image" src="/img/events/launch-week-1/287d5481-70cd-4ca8-8c12-e85f27e383f2.gif" alt="Query for avg order value"/>
...
<figure data-zoomable align='center'>
<OptimizedImg className="box-shadowed-image" src="/img/events/launch-week-1/add-new-pipeline.webp" alt="Add a new pipeline"/>
...
<figure data-zoomable align='center'>
<OptimizedImg className="box-shadowed-image" src="/img/events/launch-week-1/create-new-pipeline.webp" alt="Create a new pipeline"/>
...
<figure data-zoomable align='center'>
<OptimizedImg className="box-shadowed-image" src="/img/events/launch-week-1/logs-pipelines-signoz.webp" alt="Add a chain of log processors"/>
...
<figure data-zoomable align='center'>
<OptimizedImg className="box-shadowed-image" src="/img/events/launch-week-1/logs-pipeline-architecture2.webp" alt="OpAMP server is integrated with our query service to handle OTel Collector configs remotely"/>
