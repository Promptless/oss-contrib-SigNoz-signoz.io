...
<div className="flex flex-wrap">
    <div className="flex-[0_0_50%] max-w-[50%] px-4">
      ...
      <a
         href="https://github.com/ram-9047" className="block">
         <img
            alt="Michael"
         ...
         <div className="flex flex-col gap-1">
            <div className="font-bold">Ram S Gupta</div>
   ...
   <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/FellipeMTX" className="block">
         <img
            alt="Marius Kimmina"
         ...
         <div className="flex flex-col gap-1">
            <div className="font-bold">Fellipe Montes</div>
            <small className="text-sm text-signoz_vanilla-400"></small>
         </div>
      </div>
   </div>
   ...
   <div className="flex-[0_0_50%] max-w-[50%] px-4">
      <div className="flex items-center gap-4">
      <a
         href="https://github.com/volodfast" className="block">
         <img
            alt="Yash Joshi"
         ...
         <div className="flex flex-col gap-1">
            <div className="font-bold">volodfast</div>
            <small className="text-sm text-signoz_vanilla-400"></small>
         </div>
      </div>
   </div>
