...
<figure data-zoomable align='center'>
    <OptimizedImg src="/img/blog/2025/09/otel-pipeline.webp" alt="OpenTelemetry uses client libraries to instrument application code which is then sent to OpenTelemetry Collectors. The OTel collector then exports it to a backend analysis tool of your choice."/>
...
<figure data-zoomable align='center'>
    <OptimizedImg src="/img/blog/2025/09/signoz-flamegraphs.webp" alt="How opentelemetry fits with an application"/>
