...
You can then access the running application at <a href="http://localhost:8090" target="_blank" rel="noopener noreferrer nofollow">localhost:8090</a>
...
In your browser, visit <a href="http://localhost:8080/" target="_blank" rel="noopener noreferrer nofollow">http://localhost:8080</a> to see the running application.
