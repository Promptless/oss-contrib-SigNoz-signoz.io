...
1. **Install Prometheus**:
    - Download the latest release from the <a href="https://prometheus.io/download/" target="_blank" rel="noopener noreferrer nofollow">Prometheus website</a>.
...
1. **Install Grafana**: Follow the instructions on the <a href="https://grafana.com/docs/grafana/latest/installation/" target="_blank" rel="noopener noreferrer nofollow">Grafana website</a>.
