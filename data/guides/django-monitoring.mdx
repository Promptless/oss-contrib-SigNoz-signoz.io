...
| Log correlation | Manual timestamp matching | You can correlate logs to traces by injecting trace context into your log format (often via SDK/logging integration). |
...
| Vendor lock-in | Prometheus ecosystem | Any OTel-compatible backend |
