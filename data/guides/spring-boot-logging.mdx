...
In this demo, we will be adding logs to a Spring Boot application using the `LoggerFactory` from SLF4J and much more. The Spring Boot application we will use in this demo is available to clone from our <a href="https://github.com/SigNoz/examples" target="_blank" rel="noopener noreferrer nofollow">repository</a>. You can set it up by following below commands:
