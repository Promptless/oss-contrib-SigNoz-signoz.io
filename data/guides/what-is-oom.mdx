...
Clone the <a href="https://github.com/SigNoz/examples" target="_blank" rel="noopener noreferrer nofollow">Python OOM Demo App GitHub repository</a> & change directory to **oom demo application**
