...
If you want to [get started](https://signoz.io/docs/userguide/hostmetrics/) quickly with PostgreSQL monitoring, you can <a href="https://github.com/SigNoz/dashboards/tree/main/postgresql" target="_blank" rel="noopener noreferrer nofollow">load</a> this JSON  dashboard config in the SigNoz dashboard UI.
