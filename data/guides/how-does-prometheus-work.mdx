...
Once Prometheus has started, in your browser, visit <a href="http://localhost:9090" target="_blank" rel="noopener noreferrer nofollow">localhost:9090</a> to access the Prometheus UI:
