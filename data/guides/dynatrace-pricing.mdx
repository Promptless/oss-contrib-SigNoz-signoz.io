...
One Reddit user shared their frustration: "We have a single host (PHP application), a SQL server instance, and an Android and iOS app." For this minimal setup, they were quoted \$20,000 annually (<a href="https://www.reddit.com/r/devops/comments/16umdhn/most_affordable_monitoring_platform_dynatrace_is/" target="_blank" rel="noopener noreferrer nofollow">source</a>).
