...
1. Download the OpenTelemetry Collector for Windows:
   ...
   ```
   *Alternatively, download from the <a href="https://github.com/open-telemetry/opentelemetry-collector-releases/releases" target="_blank" rel="noopener noreferrer nofollow">releases page</a>.*
