...
5. **Import Dashboard:** 
Click `New Dashboard` and then import JSON file to create an existing dashboard. For this demo we are using SigNoz <a href="https://github.com/SigNoz/dashboards/blob/main/hostmetrics/hostmetrics.json" target="_blank" rel="noopener noreferrer nofollow">Hostmetrics JSON</a> Dashboard. For more information, refer to [**Hostmetrics** documentation](https://signoz.io/docs/userguide/hostmetrics/#setup).
