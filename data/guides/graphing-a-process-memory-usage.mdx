...
If the app and otel-contrib ran without error, all your metrics would be sent to your SigNoz cloud. The next step is to create a dashboard to view the metrics data. For SigNoz, we have shared some commonly used dashboard JSON files <a href="https://github.com/SigNoz/dashboards" target="_blank" rel="noopener noreferrer nofollow">here</a>. 
    
    For this example, we will use the <a href="https://github.com/SigNoz/dashboards/blob/main/jvm/jvm-metrics-by-service.json" target="_blank" rel="noopener noreferrer nofollow">JVM Metrics By Service</a> JSON file. To know more about how to import & customize Dashboards in SigNoz check our documentation [here](https://signoz.io/docs/userguide/manage-dashboards/). 
