...
Or you can also install and self-host <a href="https://github.com/signoz/signoz" target="_blank" rel="noopener noreferrer nofollow">SigNoz</a> yourself since it is open-source. Find the [instructions](https://signoz.io/docs/install/) to self-host SigNoz.
