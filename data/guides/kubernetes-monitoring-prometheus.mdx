...
On your browser, navigate to <a href="http://localhost:9090" target="_blank" rel="noopener noreferrer nofollow">localhost:9090</a> to see the Prometheus UI:
...
If you're excited about SigNoz and want to go deeper, <a href="https://signoz-community.slack.com/join/shared_invite/zt-1v5ms4lg2-uupFbX9_qFIWNeVXbMszkw#/shared-invite/email" target="_blank" rel="noopener noreferrer nofollow">join the SigNoz Slack</a> to be part of this awesome open-source community!