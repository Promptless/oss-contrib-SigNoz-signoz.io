...
An **SLI**, according to the <a href="https://sre.google/sre-book/service-level-objectives/" target="_blank" rel="noopener noreferrer nofollow">Google SRE Book</a>, is "a carefully defined quantitative measure of some aspect of the level of service that is provided." In simpler terms, it's any metric that tells you how well your service is performing.
...
An **SLA** is a contract with consequences. The <a href="https://sre.google/sre-book/service-level-objectives/" target="_blank" rel="noopener noreferrer nofollow">Google SRE Book</a> puts it simply: "SLAs are an explicit or implicit contract with your users that includes consequences of meeting (or missing) the SLOs they contain."
...
AWS provides a documented example of how SLAs work in practice. The <a href="https://aws.amazon.com/compute/sla/" target="_blank" rel="noopener noreferrer nofollow">AWS Compute SLA</a> for EC2 includes two separate commitments.
