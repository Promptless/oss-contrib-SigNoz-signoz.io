...
Download and install Grafana from the <a href="https://grafana.com/docs/grafana/latest/setup-grafana/installation/mac/" target="_blank" rel="noopener noreferrer nofollow">official website</a>. Follow the installation instructions for your operating system.
...
- Log in with the default credentials (admin/admin, you an read detailed guide to login <a href="https://grafana.com/docs/grafana/latest/setup-grafana/sign-in-to-grafana/" target="_blank" rel="noopener noreferrer nofollow">here</a>).
