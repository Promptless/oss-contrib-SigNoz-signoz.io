      ...
      "step": [
        {
          "@type": "HowToStep",
          "name": "Install Helm",
          "text": "Install Helm by following the official documentation: <a href="https://helm.sh/docs/intro/install/" target="_blank" rel="noopener noreferrer nofollow">Helm Installation Guide</a>"
        },
        {
          "@type": "HowToStep",
...
Install Helm by following the official documentation: <a href="https://helm.sh/docs/intro/install/" target="_blank" rel="noopener noreferrer nofollow">Helm Installation Guide</a>
...
- <a href="https://prometheus.io/docs/introduction/overview/" target="_blank" rel="noopener noreferrer nofollow">Official Prometheus Documentation</a>
- <a href="https://github.com/prometheus-community/helm-charts" target="_blank" rel="noopener noreferrer nofollow">Helm Charts Repository for Prometheus and Grafana</a>