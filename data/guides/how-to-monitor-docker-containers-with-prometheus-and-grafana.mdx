...
1. Access Grafana at <a href="http://localhost:3000/" target="_blank" rel="noopener noreferrer nofollow">http://localhost:3000</a> (default credentials: admin/admin).
2. Add Prometheus as a data source:
    - Go to Configuration > Data Sources
    - Click "Add data source" and select Prometheus
    - Set the URL to <a href="http://172.17.0.1:9090/" target="_blank" rel="noopener noreferrer nofollow">http://172.17.0.1:9090</a> (Docker host IP)
    - Click "Save & Test"
