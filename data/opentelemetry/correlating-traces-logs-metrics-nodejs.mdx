...
<figure data-zoomable align='center'>
  <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" alt="" src="/img/blog/2024/06/correlating-traces-logs-metrics-nodejs-logs-pipeline.webp" />
</figure>
...
<figure data-zoomable align='center'>
  <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" alt="" src="/img/blog/2024/06/correlating-traces-logs-metrics-nodejs-new-pipeline.webp" />
</figure>
...
<figure data-zoomable align='center'>
  <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" alt="" src="/img/blog/2024/06/correlating-traces-logs-metrics-nodejs-complete-the-setup.webp" />
</figure>
...
<figure data-zoomable align='center'>
  <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" alt="" src="/img/blog/2024/06/correlating-traces-logs-metrics-nodejs-add-processor.webp" />
</figure>
...
<figure data-zoomable align='center'>
  <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" alt="" src="/img/blog/2024/06/correlating-traces-logs-metrics-nodejs-simulate.webp" />
</figure>
...
<figure data-zoomable align='center'>
  <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" alt="" src="/img/blog/2024/06/correlating-traces-logs-metrics-nodejs-verify.webp" />
</figure>
