...
<figure data-zoomable align='center'>
  <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" alt="SigNoz UI showing RED metrics" src="/img/blog/common/signoz_charts_application_metrics.webp" />
...
<figure data-zoomable align='center'>
  <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" alt="SigNoz UI showing RED metrics" src="/img/blog/common/signoz_flamegraphs.webp" />
