...
<figure data-zoomable align='center'>
   <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" alt="SigNoz dashboard showing application list" src="/img/blog/2021/08/openetelemetry_tomcat_signoz_dashboard.webp" />
...
<figure data-zoomable align='center'>
   <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" alt="Tomcat shows up in the list of applications monitored by SigNoz" src="/img/blog/2021/08/opentelemetry_tomcat_ui.webp" />
...
<figure data-zoomable align='center'>
   <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" alt="SigNoz UI showing charts" src="/img/blog/2021/08/opentelemetry_tomcat_signoz_charts.webp" />
...
<figure data-zoomable align='center'>
   <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" alt="View of traces at a particular timestamp" src="/img/blog/2021/08/opentelemetry_regex.webp" />
...
<figure data-zoomable align='center'>
   <img className="rounded-[6px] shadow-[2px_10px_24px_rgba(34,34,34,0.2)]" alt="Flamegraphs" src="/img/blog/2021/08/opentelemetry_tomcat_flamegraphs.webp" />
