...
To avoid manual setup, clone the <a href="https://github.com/LuffySama-Dev/SampleNodejsExample" target="_blank" rel="noopener noreferrer nofollow">**sample Node.js app repository**</a>, which is contains a sample node.js app. You can refer to <a href="https://github.com/LuffySama-Dev/SampleNodejsExample/blob/main/README.md" target="_blank" rel="noopener noreferrer nofollow">README.md</a> for setup.
