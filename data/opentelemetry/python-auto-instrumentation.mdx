...
Code for this tutorial: <a href="https://github.com/SigNoz/opentelemetry-python-example/tree/main/lesson-3-1" target="_blank" rel="noopener noreferrer nofollow">GitHub Repo Link</a>
