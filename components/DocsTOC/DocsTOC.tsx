...
const DocsTOC: React.FC<DocsTOCProps> = ({ toc, hideTableOfContents, source }) => {
  ...
  return (
    <>
      <div
        className="sticky top-[50px] box-border flex h-[calc(100vh-156px)] w-80 min-w-80 max-w-80 flex-shrink-0 flex-col gap-1 overflow-x-hidden overflow-y-hidden p-0 px-4 max-lg:hidden"
        ref={tocContainerRef}
      >
        <div className="mb-4">
          <RegionDropdown />
