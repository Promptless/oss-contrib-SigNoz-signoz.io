        ...
        <div className="w-[52vw] shadow-[-4px_-40px_80px_146px_rgba(11,12,14,0.8)]">
          ...
          >
            <Button
              ...
              className="flex h-8 items-center justify-center gap-1.5 truncate rounded-full bg-signoz_ink-600 px-4 py-2 pl-4 pr-3 text-center text-sm font-medium not-italic leading-5 text-white no-underline outline-none hover:text-white"
            >
