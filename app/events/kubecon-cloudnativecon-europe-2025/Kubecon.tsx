  ...
  return (
    <>
      <section className="flex w-full flex-col items-start px-20 pt-12 font-medium max-md:max-w-full max-md:px-5">
        <div className="mx-auto !mt-[-40px] mb-0 ml-5 flex max-h-full w-full max-w-full flex-col border-l border-r border-dashed border-signoz_slate-100 !px-0">
            ...
            <div className="mt-6 flex flex-col justify-between gap-4 sm:mt-0 sm:pr-4">
              ...
              <div className="flex flex-col gap-2">
                <Link
                  ...
                  className="mb-6 flex w-full items-center justify-center gap-2 rounded-full bg-signoz_ink-250 px-3 py-2 sm:mb-0 sm:max-w-fit"
                >
                  <Megaphone size={16} />
  ...
  return (
    <div className="flex flex-col gap-16 px-20 font-medium max-md:max-w-full max-md:px-5 ">
      <div className="bg-[url('/img/background_blur/Frame_2185.png')] bg-[length:45%] bg-[center_top_-12rem] sm:bg-no-repeat">
        <section className="mx-auto flex max-h-full w-full max-w-full flex-col border-l border-r border-dashed border-signoz_slate-100 !px-0">
