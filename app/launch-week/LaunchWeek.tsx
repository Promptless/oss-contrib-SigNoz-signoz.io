            ...
            <div className="flex flex-col justify-between gap-4 sm:pr-4">
              ...
              <div className="flex flex-col gap-2">
                <Link
                  ...
                  className="flex w-full items-center justify-center gap-2 rounded-full bg-[#181a21] px-3 py-2 sm:mb-0"
                >
                ...
                <div
                  ...
                  className="mb-2 flex w-full cursor-pointer items-center justify-center gap-2 rounded-full bg-[#181a21] px-3 py-2 sm:mb-0"
