...
/**
 * Shared layout for the (opentelemetry-hub-routes) route group. Renders the
 * OpenTelemetry Hub sidebar shell when the current pathname matches a hub
 * route. Because /blog, /comparisons, /guides, and /opentelemetry all live
 * inside this route group, the sidebar persists across cross-segment
 * navigations.
 *
 * Non-hub pages (e.g. a regular blog post) pass through transparently.
 */
